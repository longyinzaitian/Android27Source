...
public final class System {
     ...
     * <tr><td>file.separator</td>     <td>{@link File#separator}</td>    <td>{@code /}</td></tr>
     *
     ...
     * <tr><td>java.io.tmpdir</td>     <td>See {@link File#createTempFile}</td> <td>{@code /sdcard}</td></tr>
     ...
     *
     * <tr><td>path.separator</td>     <td>See {@link File#pathSeparator}</td> <td>{@code :}</td></tr>
     *
