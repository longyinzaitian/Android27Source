...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void enablePointerLocation() {
        if (mPointerLocationView == null) {
            ...
            LayoutParams lp = new LayoutParams(
                    ...
                    LayoutParams.MATCH_PARENT);
            lp.type = LayoutParams.TYPE_SECURE_SYSTEM_OVERLAY;
            ...
            lp.inputFeatures |= LayoutParams.INPUT_FEATURE_NO_INPUT_CHANNEL;
    ...
    public void adjustWindowParamsLw(LayoutParams attrs) {
        switch (attrs.type) {
            ...
            case TYPE_SECURE_SYSTEM_OVERLAY:
                ...
                attrs.flags |= LayoutParams.FLAG_NOT_FOCUSABLE
                        | LayoutParams.FLAG_NOT_TOUCHABLE;
                attrs.flags &= ~LayoutParams.FLAG_WATCH_OUTSIDE_TOUCH;
                break;
            case TYPE_STATUS_BAR:
                ...
                if (mKeyguardOccluded) {
                    attrs.flags &= ~LayoutParams.FLAG_SHOW_WALLPAPER;
                    attrs.privateFlags &= ~LayoutParams.PRIVATE_FLAG_KEYGUARD;
                }
                break;
    ...
    public StartingSurface addSplashScreen(IBinder appToken, String packageName, int theme,
        ...
        try {
            ...
            win.setType(
                LayoutParams.TYPE_APPLICATION_STARTING);
            ...
            win.setLayout(LayoutParams.MATCH_PARENT,
                    LayoutParams.MATCH_PARENT);

            final LayoutParams params = win.getAttributes();
            params.token = appToken;
            params.packageName = packageName;
            params.windowAnimations = win.getWindowStyle().getResourceId(
                    com.android.internal.R.styleable.Window_windowAnimationStyle, 0);
            params.privateFlags |=
                    LayoutParams.PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED;
            params.privateFlags |= LayoutParams.PRIVATE_FLAG_SHOW_FOR_ALL_USERS;

            if (!compatInfo.supportsScreen()) {
                params.privateFlags |= LayoutParams.PRIVATE_FLAG_COMPATIBLE_WINDOW;
            }
    ...
    @Override
    public boolean getInsetHintLw(LayoutParams attrs, Rect taskBounds,
    ...
    private boolean shouldUseOutsets(LayoutParams attrs, int fl) {
        return attrs.type == TYPE_WALLPAPER || (fl & (LayoutParams.FLAG_FULLSCREEN
                | LayoutParams.FLAG_LAYOUT_IN_OVERSCAN)) != 0;
    }
    ...
    private boolean canReceiveInput(WindowState win) {
        boolean notFocusable =
                (win.getAttrs().flags & LayoutParams.FLAG_NOT_FOCUSABLE) != 0;
        boolean altFocusableIm =
                (win.getAttrs().flags & LayoutParams.FLAG_ALT_FOCUSABLE_IM) != 0;
        ...
        if (!isDefaultDisplay) {
           ...
           layoutWallpaper(win, pf, df, of, cf);
            ...
            final boolean inheritTranslucentDecor = (attrs.privateFlags
                    & LayoutParams.PRIVATE_FLAG_INHERIT_TRANSLUCENT_DECOR) != 0;
            final boolean isAppWindow =
                    attrs.type >= LayoutParams.FIRST_APPLICATION_WINDOW &&
                    attrs.type <= LayoutParams.LAST_APPLICATION_WINDOW;
            final boolean topAtRest =
                    win == mTopFullscreenOpaqueWindowState && !win.isAnimatingLw();
            if (isAppWindow && !inheritTranslucentDecor && !topAtRest) {
                if ((sysUiFl & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0
                        && (fl & LayoutParams.FLAG_FULLSCREEN) == 0
                        && (fl & LayoutParams.FLAG_TRANSLUCENT_STATUS) == 0
                        && (fl & LayoutParams.
                ...
                if ((fl & LayoutParams.FLAG_TRANSLUCENT_NAVIGATION) == 0
                ...
                if (attached != null) {
                    ...
                    if (attrs.type == TYPE_STATUS_BAR_PANEL
                        ...
                        if (DEBUG_LAYOUT) Slog.v(TAG, String.format(
                            ...
                            && attrs.type >= LayoutParams.FIRST_APPLICATION_WINDOW
                            && attrs.type <= LayoutParams.LAST_SUB_WINDOW) {
    ...
    public int finishPostLayoutPolicyLw() {
        ...
        final LayoutParams lp = (mTopFullscreenOpaqueWindowState != null)
        ...
        mHandler.post(new Runnable() {
            @Override public void run() {
                if (mBootMsgDialog == null) {
                    ...
                    LayoutParams lp = mBootMsgDialog.getWindow().getAttributes();
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        final boolean hideStatusBarWM =
                ...
                && (PolicyControl.getWindowFlags(mTopFullscreenOpaqueWindowState, null)
                        & LayoutParams.FLAG_FULLSCREEN) != 0;
    ...
    public boolean canMagnifyWindow(int windowType) {
        switch (windowType) {
            case LayoutParams.TYPE_INPUT_METHOD:
            case LayoutParams.TYPE_INPUT_METHOD_DIALOG:
            case LayoutParams.TYPE_NAVIGATION_BAR:
            case LayoutParams.TYPE_MAGNIFICATION_OVERLAY: {
                return false;
            }
        }
        return true;
    ...
    public boolean isTopLevelWindow(int windowType) {
        if (windowType >= LayoutParams.FIRST_SUB_WINDOW
                && windowType <= LayoutParams.LAST_SUB_WINDOW) {
            return (windowType == LayoutParams.TYPE_APPLICATION_ATTACHED_DIALOG);
        }
        return true;
    }
