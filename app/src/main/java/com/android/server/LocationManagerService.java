...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        synchronized (mLock) {
            ...
            for (Entry<PackageProviderKey, PackageStatistics> entry
            ...
            for (Entry<String, Location> entry : mLastLocation.entrySet()) {
                String provider = entry.getKey();
            ...
            for (Entry<String, Location> entry : mLastLocationCoarseInterval.entrySet()) {
                String provider = entry.getKey();
                Location location = entry.getValue();
                pw.println("    " + provider + ": " + location);
            }
            ...
            if (mMockProviders.size() > 0) {
                ...
                for (Entry<String, MockProvider> i : mMockProviders.entrySet()) {
                    i.getValue().dump(pw, "      ");
                }
            }
