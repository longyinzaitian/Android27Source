...
public class InputManagerService extends IInputManager.Stub
    ...
    public void enableInputDevice(int deviceId) {
        if (!checkCallingPermission(Manifest.permission.DISABLE_INPUT_DEVICE,
                "enableInputDevice()")) {
    ...
    public int isInTabletMode() {
        if (!checkCallingPermission(Manifest.permission.TABLET_MODE,
                "isInTabletMode()")) {
    ...
    public void setCurrentKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier,
        ...
        if (!checkCallingPermission(Manifest.permission.SET_KEYBOARD_LAYOUT,
                "setCurrentKeyboardLayoutForInputDevice()")) {
    ...
    public void tryPointerSpeed(int speed) {
        if (!checkCallingPermission(Manifest.permission.SET_POINTER_SPEED,
                "tryPointerSpeed()")) {
    ...
    public IInputForwarder createInputForwarder(int displayId) throws RemoteException {
        if (!checkCallingPermission(Manifest.permission.INJECT_EVENTS,
    ...
    private boolean checkInjectEventsPermission(int injectorPid, int injectorUid) {
        return mContext.checkPermission(Manifest.permission.INJECT_EVENTS,
