...
public final class NetworkStatsAccess {
    ...
    /** Returns the {@link Level} for the given caller. */
    public static @Level int checkAccessLevel(
    ...
    public static boolean isAccessibleToUser(int uid, int callerUid,
            @Level int accessLevel) {
        switch (accessLevel) {
            case Level.DEVICE:
                // Device-level access - can access usage for any uid.
                return true;
            case Level.DEVICESUMMARY:
