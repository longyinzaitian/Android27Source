...
public class AudioService extends IAudioService.Stub
   ...
   /** Maximum volume index values for audio streams */
    ...
    private boolean updateRingerModeAffectedStreams() {
        int ringerModeAffectedStreams = System.getIntForUser(mContentResolver,
    ...
    boolean checkAudioSettingsPermission(String method) {
        if (mContext.checkCallingOrSelfPermission(Manifest.permission.MODIFY_AUDIO_SETTINGS)
                == PackageManager.PERMISSION_GRANTED) {
            return true;
        }
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        SettingsObserver() {
            super(new Handler());
            mContentResolver.registerContentObserver(System.getUriFor(
                System.MODE_RINGER_STREAMS_AFFECTED), false, this);
            mContentResolver.registerContentObserver(Settings.Global.getUriFor(
                Settings.Global.DOCK_AUDIO_MEDIA_ENABLED), false, this);
            mContentResolver.registerContentObserver(System.getUriFor(
                    System.MASTER_MONO), false, this);
