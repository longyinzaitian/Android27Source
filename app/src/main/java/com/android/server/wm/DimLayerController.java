...
class DimLayerController {
    ...
    void startDimmingIfNeeded(DimLayerUser dimLayerUser,
    ...
    void stopDimmingIfNeeded() {
        ...
        for (int i = mState.size() - 1; i >= 0; i--) {
            DimLayerUser dimLayerUser = mState.keyAt(i);
    ...
    boolean animateDimLayers() {
        ...
        for (int i = mState.size() - 1; i >= 0; i--) {
            final DimLayerUser user = mState.keyAt(i);
    ...
    void applyDim(
            DimLayerUser dimLayerUser, WindowStateAnimator animator, boolean aboveApp) {
