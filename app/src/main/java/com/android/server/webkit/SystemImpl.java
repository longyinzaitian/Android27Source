...
public class SystemImpl implements SystemInterface {
    ...
    public String getUserChosenWebViewProvider(Context context) {
        return Global.getString(context.getContentResolver(),
                Global.WEBVIEW_PROVIDER);
    }

    @Override
    public void updateUserSetting(Context context, String newProviderName) {
        Global.putString(context.getContentResolver(),
                Global.WEBVIEW_PROVIDER,
    ...
    public boolean isFallbackLogicEnabled() {
        ...
        return Global.getInt(AppGlobals.getInitialApplication().getContentResolver(),
                Global.WEBVIEW_FALLBACK_LOGIC_ENABLED, 1) == 1;
    }

    @Override
    public void enableFallbackLogic(boolean enable) {
        Global.putInt(AppGlobals.getInitialApplication().getContentResolver(),
                Global.WEBVIEW_FALLBACK_LOGIC_ENABLED, enable ? 1 : 0);
    }
