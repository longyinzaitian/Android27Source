...
public class PasspointProvider {
    ...
    private void buildEnterpriseConfigForUserCredential(WifiEnterpriseConfig config,
        ...
        switch (credential.getNonEapInnerMethod()) {
            case UserCredential.AUTH_METHOD_PAP:
                phase2Method = WifiEnterpriseConfig.Phase2.PAP;
                break;
            case UserCredential.AUTH_METHOD_MSCHAP:
                phase2Method = WifiEnterpriseConfig.Phase2.MSCHAP;
                break;
            case UserCredential.AUTH_METHOD_MSCHAPV2:
    ...
    private static UserCredential buildUserCredentialFromEnterpriseConfig(
        ...
        switch(config.getPhase2Method()) {
            case WifiEnterpriseConfig.Phase2.PAP:
                userCredential.setNonEapInnerMethod(UserCredential.AUTH_METHOD_PAP);
                break;
            case WifiEnterpriseConfig.Phase2.MSCHAP:
                userCredential.setNonEapInnerMethod(UserCredential.AUTH_METHOD_MSCHAP);
                break;
            case WifiEnterpriseConfig.Phase2.MSCHAPV2:
                userCredential.setNonEapInnerMethod(UserCredential.AUTH_METHOD_MSCHAPV2);
                break;
            default:
    ...
    /**
     * Helper function for creating a
     * {@link SimCredential} from the given
     * {@link WifiEnterpriseConfig}
     *
     * @param eapType The EAP type of the SIM credential
     * @param config The enterprise configuration containing the credential
     * @return {@link SimCredential}
     */
    private static SimCredential buildSimCredentialFromEnterpriseConfig(
