...
public class WifiServiceImpl extends IWifiManager.Stub {
    ...
    /**
     * see {@link WifiManager#startScan}
     * and {@link WifiManager#startCustomizedScan}
     *
    ...
    private boolean checkNetworkSettingsPermission(int pid, int uid) {
        return mContext.checkPermission(Manifest.permission.NETWORK_SETTINGS, pid, uid)
    ...
    private void enforceNetworkStackPermission() {
        mContext.enforceCallingOrSelfPermission(Manifest.permission.NETWORK_STACK,
                "WifiService");
    }

    private void enforceAccessPermission() {
        mContext.enforceCallingOrSelfPermission(Manifest.permission.ACCESS_WIFI_STATE,
                "WifiService");
    }

    private void enforceChangePermission() {
        mContext.enforceCallingOrSelfPermission(Manifest.permission.CHANGE_WIFI_STATE,
                "WifiService");
    }
    ...
    private void enforceReadCredentialPermission() {
        mContext.enforceCallingOrSelfPermission(Manifest.permission.READ_WIFI_CREDENTIAL,
                                                "WifiService");
    }

    private void enforceWorkSourcePermission() {
        mContext.enforceCallingPermission(Manifest.permission.UPDATE_DEVICE_STATS,
                "WifiService");
    ...
    /**
     * see {@link WifiManager#setWifiEnabled(boolean)}
    ...
    /**
     * see {@link WifiManager#setWifiApEnabled(WifiConfiguration, boolean)}
    ...
    /**
     * see {@link WifiManager#updateInterfaceIpState(String, int)}
     *
    ...
    /**
     * see {@link WifiManager#startSoftAp(WifiConfiguration)}
    ...
    /**
     * see {@link WifiManager#stopSoftAp()}
    ...
    /**
     * see {@link WifiManager#isScanAlwaysAvailable()}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#disconnect()}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#reconnect()}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#reassociate()}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#getSupportedFeatures}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#getControllerActivityEnergyInfo(int)}
     */
    @Override
    ...
    /**
     * see {@link WifiManager#getConfiguredNetworks()}
    ...
    /**
     * see {@link WifiManager#getPrivilegedConfiguredNetworks()}
    ...
    /**
     * see {@link WifiManager#addOrUpdateNetwork(WifiConfiguration)}
    ...
    /**
     * See {@link WifiManager#removeNetwork(int)}
    ...
    /**
     * See {@link WifiManager#enableNetwork(int, boolean)}
     * @param netId the integer that identifies the network configuration
     * to the supplicant
    ...
    /**
     * See {@link WifiManager#disableNetwork(int)}
     * @param netId the integer that identifies the network configuration
     * to the supplicant
     * @return {@code true} if the operation succeeded
     */
