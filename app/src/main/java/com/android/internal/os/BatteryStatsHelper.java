...
public class BatteryStatsHelper {
    ...
    private void processAppUsage(SparseArray<UserHandle> asUsers) {
        ...
        for (int iu = 0; iu < NU; iu++) {
            ...
            final BatterySipper app = new BatterySipper(DrainType.APP, u, 0);
    ...
    private void addRadioUsage() {
        BatterySipper radio = new BatterySipper(DrainType.CELL, null, 0);
    ...
    private void addIdleUsage() {
        ...
        if (totalPowerMah != 0) {
            addEntry(DrainType.IDLE, mTypeBatteryRealtimeUs / 1000, totalPowerMah);
        }
    }
    ...
    private void addBluetoothUsage() {
        BatterySipper bs = new BatterySipper(DrainType.BLUETOOTH, null, 0);
    ...
    public void smearScreenBatterySipper(List<BatterySipper> sippers, BatterySipper screenSipper) {
        ...
        for (int i = 0, size = sippers.size(); i < size; i++) {
            final Uid uid = sippers.get(i).uidObj;
            if (uid != null) {
    ...
    public long getProcessForegroundTimeMs(Uid uid, int which) {
        ...
        final int foregroundTypes[] = {Uid.PROCESS_STATE_TOP};
        ...
        try {
            ...
            if (pfd != null) {
                try (FileInputStream fis = new ParcelFileDescriptor.AutoCloseInputStream(pfd)) {
                    ...
                    parcel.unmarshall(data, 0, data.length);
                    parcel.setDataPosition(0);
                    BatteryStatsImpl stats = BatteryStatsImpl.CREATOR
