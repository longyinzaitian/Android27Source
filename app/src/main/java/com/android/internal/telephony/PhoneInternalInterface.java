...
public interface PhoneInternalInterface {
     ...
     * {@link #registerForPreciseCallStateChanged(Handler, int,
     * Object) registerForPreciseCallStateChanged()}.
     *
     ...
     * ServiceState#getState() getState()}.
     ...
     * @param onComplete a callback message when the action is completed.
     *        @see CallForwardInfo for details.
     */
     ...
     *
     * @param onComplete a callback message when the action is completed.
     *        @see CommandsInterface#getCLIR for details.
     */
     ...
     *
     * @param onComplete a callback message when the action is completed.
     *        @see CommandsInterface#queryCallWaiting for details.
     */
