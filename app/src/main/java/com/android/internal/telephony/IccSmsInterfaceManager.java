...
public class IccSmsInterfaceManager {
    ...
    /**
     * Enforces that the caller has {@link Manifest.permission#MODIFY_PHONE_STATE}
    ...
    private void enforcePrivilegedAppPermissions() {
        if (mContext.checkCallingOrSelfPermission(Manifest.permission.MODIFY_PHONE_STATE)
