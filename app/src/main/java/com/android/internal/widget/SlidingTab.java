...
public class SlidingTab extends ViewGroup {
    ...
    private static class Slider {
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            tab.measure(MeasureSpec.makeSafeMeasureSpec(width, MeasureSpec.UNSPECIFIED),
                    MeasureSpec.makeSafeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
            text.measure(MeasureSpec.makeSafeMeasureSpec(width, MeasureSpec.UNSPECIFIED),
                    MeasureSpec.makeSafeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
        }
