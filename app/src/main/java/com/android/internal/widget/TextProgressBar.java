 ...
 * {@link ViewGroup.LayoutParams#WRAP_CONTENT}, then the
 ...
 * {@link Gravity#LEFT} then the {@link Chronometer} will be placed
...
public class TextProgressBar extends RelativeLayout implements OnChronometerTickListener {
    ...
    public void onChronometerTick(Chronometer chronometer) {
        ...
        if (mChronometerFollow) {
            ...
            params = (LayoutParams) mChronometer.getLayoutParams();
