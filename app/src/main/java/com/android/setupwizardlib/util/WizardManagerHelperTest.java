...
public class WizardManagerHelperTest {
    ...
    public void testIsUserSetupComplete() {
        Secure.putInt(application.getContentResolver(), Global.DEVICE_PROVISIONED, 1);
        Secure.putInt(application.getContentResolver(), "user_setup_complete", 1);
        assertTrue(WizardManagerHelper.isUserSetupComplete(application));

        Secure.putInt(application.getContentResolver(), "user_setup_complete", 0);
    ...
    public void testIsUserSetupCompleteCompat() {
        Secure.putInt(application.getContentResolver(), Secure.DEVICE_PROVISIONED, 1);
        assertTrue(WizardManagerHelper.isUserSetupComplete(application));

        Secure.putInt(application.getContentResolver(), Secure.DEVICE_PROVISIONED, 0);
        assertFalse(WizardManagerHelper.isUserSetupComplete(application));
    }
    ...
    public void testIsDeviceProvisioned() {
        ...
        Secure.putInt(application.getContentResolver(), Global.DEVICE_PROVISIONED, 0);
