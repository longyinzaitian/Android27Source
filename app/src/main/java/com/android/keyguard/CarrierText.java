...
public class CarrierText extends TextView {
     ...
     */
    private CharSequence getCarrierTextForSimState(State simState,
            CharSequence text) {
    ...
    private StatusMode getStatusForIccState(State simState) {
        ...
        final boolean missingAndNotProvisioned =
                ...
                && (simState == State.ABSENT ||
                        simState == State.PERM_DISABLED);
    ...
    private CharSequence getCarrierHelpTextForSimState(State simState,
