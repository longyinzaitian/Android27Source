...
public class ImsManager {
    ...
    public static void setEnhanced4gLteModeSetting(Context context, boolean enabled) {
        ...
        Settings.Global.putInt(
                context.getContentResolver(),
                Settings.Global.ENHANCED_4G_MODE_ENABLED, value);
    ...
    public void setEnhanced4gLteModeSettingForSlot(boolean enabled) {
        ...
        try {
            int prevSetting = Settings.Global.getInt(mContext.getContentResolver(),
                    Settings.Global.ENHANCED_4G_MODE_ENABLED);
    ...
    public static void setVtSetting(Context context, boolean enabled) {
        ...
        Settings.Global.putInt(context.getContentResolver(),
                Settings.Global.VT_IMS_ENABLED, value);
    ...
    public static void setWfcSetting(Context context, boolean enabled) {
        int value = enabled ? 1 : 0;
        Settings.Global.putInt(context.getContentResolver(),
                Settings.Global.WFC_IMS_ENABLED, value);
    ...
    public static int getWfcMode(Context context) {
        int setting = Settings.Global.getInt(context.getContentResolver(),
                Settings.Global.WFC_IMS_MODE, getIntCarrierConfig(context,
    ...
    public int getWfcModeForSlot() {
        int setting = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.WFC_IMS_MODE, getIntCarrierConfigForSlot(
                        CarrierConfigManager.KEY_CARRIER_DEFAULT_WFC_IMS_MODE_INT));
        if (DBG) log("getWfcMode - setting=" + setting);
        return setting;
    }
    ...
    public static void setWfcMode(Context context, int wfcMode) {
        ...
        Settings.Global.putInt(context.getContentResolver(),
                Settings.Global.WFC_IMS_MODE, wfcMode);
    ...
    public static int getWfcMode(Context context, boolean roaming) {
        int setting = 0;
        if (!roaming) {
            setting = Settings.Global.getInt(context.getContentResolver(),
                    Settings.Global.WFC_IMS_MODE, getIntCarrierConfig(context,
                            CarrierConfigManager.KEY_CARRIER_DEFAULT_WFC_IMS_MODE_INT));
            if (DBG) log("getWfcMode - setting=" + setting);
        } else {
    ...
    public static void setWfcMode(Context context, int wfcMode, boolean roaming) {
        if (!roaming) {
            ...
            Settings.Global.putInt(context.getContentResolver(),
                    Settings.Global.WFC_IMS_ROAMING_MODE, wfcMode);
        }
