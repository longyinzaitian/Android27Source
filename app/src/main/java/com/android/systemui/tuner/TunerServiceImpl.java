...
public class TunerServiceImpl extends TunerService {
    ...
    private void upgradeTuner(int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            ...
            if (blacklistStr != null) {
                ...
                Secure.putStringForUser(mContentResolver,
    ...
    public String getValue(String setting) {
        return Secure.getStringForUser(mContentResolver, setting, mCurrentUser);
    }

    @Override
    public void setValue(String setting, String value) {
         Secure.putStringForUser(mContentResolver, setting, value, mCurrentUser);
    }

    @Override
    public int getValue(String setting, int def) {
        return Secure.getIntForUser(mContentResolver, setting, def, mCurrentUser);
    }
    ...
    public void setValue(String setting, int value) {
         Secure.putIntForUser(mContentResolver, setting, value, mCurrentUser);
    }
    ...
    private void addTunable(Tunable tunable, String key) {
        ...
        String value = Secure.getStringForUser(mContentResolver, key, mCurrentUser);
    ...
    private void reloadAll() {
        for (String key : mTunableLookup.keySet()) {
            String value = Secure.getStringForUser(mContentResolver, key,
                    mCurrentUser);
    ...
    public void clearAll() {
        ...
        for (String key : mTunableLookup.keySet()) {
            Secure.putString(mContentResolver, key, null);
        }
    }
