...
public class ComplexDatabase_Impl extends ComplexDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        final Callback _openCallback = new RoomOpenHelper(configuration, new Delegate(1923) {
            ...
            protected void validateMigration(SupportSQLiteDatabase _db) {
                final HashMap<String, Column> _columnsUser = new HashMap<String, Column>(4);
                _columnsUser.put("uid", new Column("uid", "INTEGER", true, 1));
                _columnsUser.put("name", new Column("name", "TEXT", false, 0));
                _columnsUser.put("lastName", new Column("lastName", "TEXT", false, 0));
                _columnsUser.put("ageColumn", new Column("ageColumn", "INTEGER", true, 0));
                final HashSet<ForeignKey> _foreignKeysUser = new HashSet<ForeignKey>(0);
