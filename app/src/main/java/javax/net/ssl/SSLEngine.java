 ...
 * traditional Input/OutputStreams, local {@link ByteBuffer
 ...
 * <code>SSLEngine</code> will create a {@link Runnable}
 ...
 * call its {@link Runnable#run() run()} method (possibly using
...
public abstract class SSLEngine {
     ...
     * Runnable} operation (task).  Each task must be assigned
     * a thread (possibly the current) to perform the {@link
     * Runnable#run() run} operation.  Once the
