 ...
 * {@link SocketOption} interface. All of the standard options defined
 * by {@link Socket}, {@link ServerSocket}, and
 * {@link DatagramSocket} can be set this way, as well as additional
 ...
 * is required for {@link StandardSocketOptions}.
 *
...
public class Sockets {
    ...
    /**
     * Sets the value of a socket option on a {@link Socket}
     *
     * @param s the socket
    ...
    /**
     * Returns the value of a socket option from a {@link Socket}
     *
     * @param s the socket
     * @param name The socket option
     *
    ...
    /**
     * Sets the value of a socket option on a {@link ServerSocket}
     *
     * @param s the socket
     * @param name The socket option
    ...
    /**
     * Returns the value of a socket option from a {@link ServerSocket}
     *
     * @param s the socket
     * @param name The socket option
     *
    ...
    /**
     * Sets the value of a socket option on a {@link DatagramSocket}
     * or {@link MulticastSocket}
     *
     * @param s the socket
     * @param name The socket option
     * @param value The value of the socket option.
     ...
     * {@link DatagramSocket} or {@link MulticastSocket}
     *
     * @param s the socket
     * @param name The socket option
     *
    ...
    /**
     * Returns a set of {@link SocketOption}s supported by the
