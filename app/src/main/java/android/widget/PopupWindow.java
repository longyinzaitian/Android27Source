...
public class PopupWindow {
    ...
    @SoftInputModeFlags
    private int mSoftInputMode = LayoutParams.SOFT_INPUT_STATE_UNCHANGED;
    ...
    private int mWindowLayoutType = LayoutParams.TYPE_APPLICATION_PANEL;
     ...
     *        {@link LayoutParams#softInputMode}
     *        for the full list
     *
     * @see LayoutParams#softInputMode
     ...
     * {@link LayoutParams#FLAG_LAYOUT_IN_SCREEN}, overriding default behavior.
     ...
     * @see LayoutParams#FLAG_LAYOUT_ATTACHED_IN_DECOR
     */
     ...
     * the flag {@link LayoutParams#FLAG_LAYOUT_ATTACHED_IN_DECOR}.
     *
     ...
     * {@link LayoutParams#FLAG_LAYOUT_INSET_DECOR}, overriding default behavior.
     ...
     * <p>
     * See {@link LayoutParams#type} for possible values.
     *
     ...
     * cannot fit on screen, it will be clipped. See {@link LayoutParams}
     * for more information on how gravity and the x and y parameters are related. Specifying
     * a gravity of {@link Gravity#NO_GRAVITY} is similar to specifying
    ...
    private int computeFlags(int curFlags) {
        ...
        if (!mFocusable) {
            ...
            if (mInputMethodMode == INPUT_METHOD_NEEDED) {
                curFlags |= LayoutParams.FLAG_ALT_FOCUSABLE_IM;
            }
        ...
        if (mOutsideTouchable) {
            curFlags |= LayoutParams.FLAG_WATCH_OUTSIDE_TOUCH;
        }
        ...
        if (mLayoutInScreen) {
            curFlags |= LayoutParams.FLAG_LAYOUT_IN_SCREEN;
        }
        if (mLayoutInsetDecor) {
            curFlags |= LayoutParams.FLAG_LAYOUT_INSET_DECOR;
        }
        if (mNotTouchModal) {
            curFlags |= LayoutParams.FLAG_NOT_TOUCH_MODAL;
        }
        if (mAttachedInDecor) {
            curFlags |= LayoutParams.FLAG_LAYOUT_ATTACHED_IN_DECOR;
        }
        return curFlags;
    }
     ...
     * @hide
     */
    protected final boolean findDropDownPosition(View anchor, LayoutParams outParams,
    ...
    public void update() {
        ...
        final LayoutParams p = getDecorViewLayoutParams();
    ...
    protected LayoutParams getDecorViewLayoutParams() {
        return (LayoutParams) mDecorView.getLayoutParams();
    }
