...
public class RemoteViews implements Parcelable, Filter {
     ...
     * {@link View#setOnClickListener(OnClickListener)}
     ...
     * {@link TextView#getCompoundDrawablesRelative()}.
     *
     * @param viewId The id of the view whose text should change.
     * @param index  The index of the drawable in the array of
     *               {@link TextView#getCompoundDrawablesRelative()} to set the color
     ...
     *            {@link View#getBackground()}. Otherwise, assume
    ...
    /**
     * @hide
     * Equivalent to calling {@link ProgressBar#setProgressTintList}.
     *
    ...
    /**
     * @hide
     * Equivalent to calling {@link ProgressBar#setProgressBackgroundTintList}.
     *
     * @param viewId The id of the view whose tint should change
     * @param tint the tint to apply, may be {@code null} to clear tint
     */
    ...
    /**
     * @hide
     * Equivalent to calling {@link ProgressBar#setIndeterminateTintList}.
     *
     * @param viewId The id of the view whose tint should change
     * @param tint the tint to apply, may be {@code null} to clear tint
     */
    ...
    /**
     * Equivalent to calling {@link TextView#setTextColor(int)}.
     *
    ...
    /**
     * @hide
     * Equivalent to calling {@link TextView#setTextColor(ColorStateList)}.
     *
     * @param viewId The id of the view whose text color should change
    ...
    /**
     * Equivalent to calling {@link AbsListView#setRemoteViewsAdapter(Intent)}.
     *
     ...
     *      {@link RemoteViews#setRemoteAdapter(int, Intent)}
     */
    @Deprecated
    ...
    /**
     * @hide
     * Equivalent to calling {@link ViewGroup.MarginLayoutParams#setMarginEnd(int)}.
    ...
    /**
     * Equivalent to setting {@link ViewGroup.MarginLayoutParams#bottomMargin}.
     *
    ...
    /**
     * Equivalent to setting {@link ViewGroup.LayoutParams#width}.
     *
     ...
     * @param viewId The id of the view on which to call the method.
     * @param methodName The name of the method to call.
     * @param value The {@link Intent} to pass the method.
     */
     ...
     * @param viewId The id of the view on which to call the method.
     * @param methodName The name of the method to call.
     * @param value The {@link Icon} to pass the method.
     */
    ...
    /**
     * Equivalent to calling {@link View#setAccessibilityTraversalBefore(int)}.
     *
    ...
    /**
     * Equivalent to calling {@link View#setAccessibilityTraversalAfter(int)}.
     *
