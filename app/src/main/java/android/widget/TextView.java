...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    /**
     * @return the {@link Layout} that is currently being used to
     ...
     * {@link R.style#TextAppearance_Material_Body1 @android:style/TextAppearance.Material.Body1}
    ...
    /**
     * Returns the list of {@link URLSpan URLSpans} attached to the text
     ...
     * display buffer, upgrading it to {@link BufferType#EDITABLE}
     ...
     * {@link EditText} it is always enabled, regardless of
     ...
     * in frozen icicles. For {@link EditText} it always returns true.
     *
     ...
     *
     * @param factory {@link Editable.Factory Editable.Factory} to be used
     *
     ...
     *
     * @param factory {@link Spannable.Factory Spannable.Factory} to be used
     *
    ...
    private boolean isMarqueeFadeEnabled() {
        return mEllipsize == TruncateAt.MARQUEE
                && mMarqueeFadeMode != MARQUEE_FADE_SWITCH_SHOW_ELLIPSIS;
    }
    ...
    static final int ID_SHARE = R.id.shareText;
    static final int ID_PASTE_AS_PLAIN_TEXT = R.id.pasteAsPlainText;
    static final int ID_REPLACE = R.id.replaceText;
    static final int ID_ASSIST = R.id.textAssist;
    static final int ID_AUTOFILL = R.id.autofill;

    /**
     * Called when a context menu option for the text view is selected.  Currently
     * this will be one of {@link R.id#selectAll}, {@link R.id#cut},
     * {@link R.id#copy}, {@link R.id#paste} or {@link R.id#shareText}.
     *
     ...
     * {@link ActionMode.Callback#onPrepareActionMode(ActionMode, android.view.Menu)}
     * method. The default actions can also be removed from the menu using
     * {@link android.view.Menu#removeItem(int)} and passing {@link R.id#selectAll},
     * {@link R.id#cut}, {@link R.id#copy}, {@link R.id#paste},
     * {@link R.id#replaceText} or {@link R.id#shareText} ids as parameters.
     *
     * <p>Returning false from
     * {@link ActionMode.Callback#onCreateActionMode(ActionMode, android.view.Menu)}
     ...
     *
     * <p>A custom implementation can add new entries in the default menu in its
     * {@link ActionMode.Callback#onPrepareActionMode(ActionMode,
     * android.view.Menu)} method. The default actions can also be removed from the menu using
     * {@link android.view.Menu#removeItem(int)} and passing {@link R.id#selectAll},
     * {@link R.id#paste} or {@link R.id#replaceText} ids as parameters.</p>
     *
     * <p>Returning false from
     * {@link ActionMode.Callback#onCreateActionMode(ActionMode,
     ...
     * {@link R.attr#selectAllOnFocus} flag has been set.</p>
     */
