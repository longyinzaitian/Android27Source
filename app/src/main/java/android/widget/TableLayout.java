 ...
 * is {@link LayoutParams#WRAP_CONTENT}. If the child
 * is a {@link TableRow}, then the height is always
 * {@link LayoutParams#WRAP_CONTENT}.</p>
 *
...
public class TableLayout extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         * {@link ViewGroup.LayoutParams#MATCH_PARENT}; the row's
         * height is fixed to
         * {@link ViewGroup.LayoutParams#WRAP_CONTENT} if no layout
