...
public class AutoCompleteTextView extends EditText implements Filter.FilterListener {
     ...
     * be a fixed width, or {@link LayoutParams#MATCH_PARENT} to fill the screen, or
     * {@link LayoutParams#WRAP_CONTENT} to fit the width of its anchor view.</p>
     *
     ...
     * be a fixed height, or {@link LayoutParams#MATCH_PARENT} to fill
     * the screen, or {@link LayoutParams#WRAP_CONTENT} to fit the height
