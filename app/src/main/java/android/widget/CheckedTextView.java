 ...
 * <p>
 * This is useful when used in a {@link ListView ListView} where
 * the {@link ListView#setChoiceMode(int) setChoiceMode} has
 * been set to something other than
 * {@link ListView#CHOICE_MODE_NONE CHOICE_MODE_NONE}.
 *
