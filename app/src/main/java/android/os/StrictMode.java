 ...
 * a variety of tools to help solve them: threads, {@link Handler},
 * {@link AsyncTask}, {@link android.app.IntentService}, etc.
 ...
 * {@link Binder} calls, it's still ultimately a best
...
public final class StrictMode {
    ...
    public static final class VmPolicy {
        ...
        public static final class Builder {
             ...
             * {@link Uri} to another app without setting
   ...
   private static class StrictModeDiskWriteViolation extends StrictModeViolation {
     ...
     * current thread's {@link ThreadPolicy} has
     * {@link ThreadPolicy.Builder#detectCustomSlowCalls}
     * enabled.
     *
     ...
     * {@link ThreadPolicy} has
     * {@link ThreadPolicy.Builder#detectResourceMismatches()}
     * enabled.
     *
    ...
    public static class ViolationInfo implements Parcelable {
        ...
        public static final Creator<ViolationInfo> CREATOR =
                new Creator<ViolationInfo>() {
                    @Override
