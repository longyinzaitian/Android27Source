 ...
 *
 * All callback methods except for onRelease should throw {@link ErrnoException}
 ...
 *
 * <ul>
 * <li>{@link OsConstants#EIO} for general I/O issues
 * <li>{@link OsConstants#ENOENT} when the file is not found
 * <li>{@link OsConstants#EBADF} if the file doesn't allow read/write operations
 *     based on how it was opened.  (For example, trying to write a file that was opened read-only.)
 * <li>{@link OsConstants#ENOSPC} if you cannot handle a write operation to
