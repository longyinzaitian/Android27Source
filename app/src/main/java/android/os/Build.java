...
public class Build {
     ...
     * For apps targeting SDK higher than {@link VERSION_CODES#N_MR1} this
    ...
    public static class VERSION_CODES {
         ...
         * {@link Manifest.permission#WRITE_EXTERNAL_STORAGE} permission to be
         * able to modify the contents of the SD card.  (Apps targeting
         * earlier versions will always request the permission.)
         * <li> They must explicitly request the
         * {@link Manifest.permission#READ_PHONE_STATE} permission to be
         ...
         * <li><p>{@link AsyncTask} will use the serial executor
         * by default when calling {@link AsyncTask#execute}.</p>
         ...
         * new changes in behavior:</p>
         * <ul>
         * <li> You must explicitly request the {@link Manifest.permission#READ_CALL_LOG}
         * and/or {@link Manifest.permission#WRITE_CALL_LOG} permissions;
         * access to the call log is no longer implicitly provided through
         * {@link Manifest.permission#READ_CONTACTS} and
         ...
         * {@link Manifest.permission#BIND_ACCESSIBILITY_SERVICE} permission or
         ...
         * <li> {@link Context#getSharedPreferences(String, int)
         ...
         * drawn.</li>
         * <li>The {@link Manifest.permission#READ_EXTERNAL_STORAGE}
         ...
         * {@link Manifest.permission#READ_EXTERNAL_STORAGE} or
         ...
         * new changes in behavior:</p>
         * <ul>
         * <li> {@link Context#bindService Context.bindService} now
         ...
         * <li> {@link Message} will validate that a message is not currently
         ...
         * {@link Manifest.permission#BIND_DREAM_SERVICE} permission to be usable.</li>
         * </ul>
         */
         ...
         * are shown.</li>
         * <li>{@link Context#MODE_WORLD_READABLE} and
         * {@link Context#MODE_WORLD_WRITEABLE} are no longer supported.</li>
         * <li>{@link FileUriExposedException} will be thrown to applications.</li>
