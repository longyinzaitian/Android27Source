...
public class CommonClock {
    ...
    /**
     * Release all native resources held by this {@link CommonClock} instance.  Once
     * resources have been released, the {@link CommonClock} instance is disconnected from
     * the native service and will throw a {@link RemoteException} if any of its
     ...
     * {@link CommonClock} instance to indicate that the time synchronization service has
     ...
     * {@link CommonClock} instance to indicate that the connection to the native media
     * server has been broken and that the {@link CommonClock} instance will need to be
    ...
    public interface OnServerDiedListener  {
         ...
         * {@link CommonClock} instance to the common time service will be broken.  To
