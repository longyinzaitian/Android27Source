 ...
 * {@link UidHealthStats#MEASUREMENT_WIFI_TX_MS UidHealthStats.MEASUREMENT_WIFI_TX_MS}
 * value is the number of milliseconds (ms) that were spent transmitting on wifi by an
 * application.  The
 * {@link UidHealthStats#MEASUREMENT_MOBILE_RX_PACKETS UidHealthStats.MEASUREMENT_MOBILE_RX_PACKETS}
 * measurement is the number of packets received on behalf of an application.
 * The {@link UidHealthStats#MEASUREMENT_TOUCH_USER_ACTIVITY_COUNT
 ...
 * {@link UidHealthStats#TIMER_FLASHLIGHT}
 * timer tracks how many times the application turned on the flashlight, and for
 * how many milliseconds total it kept it on.
 *
 * <p>
 * A <b>measurement map</b> metric is a mapping of {@link String} names to
 * {@link Long} values.  The names typically are application provided names. For
 * example, the
 * {@link PackageHealthStats#MEASUREMENTS_WAKEUP_ALARMS_COUNT
 ...
 *
 * <p>
 * A <b>timer map</b> metric is a mapping of {@link String} names to
 * {@link TimerStat} objects. The names are typically application
 * provided names.  For example, the
 * {@link UidHealthStats#TIMERS_WAKELOCKS_PARTIAL UidHealthStats.TIMERS_WAKELOCKS_PARTIAL}
 ...
 *
 * <p>
 * Lastly, a <b>health stats</b> metric is a mapping of {@link String}
 * names to a recursive {@link HealthStats} object containing
 * more detailed information. For example, the
 * {@link UidHealthStats#STATS_PACKAGES UidHealthStats.STATS_PACKAGES}
