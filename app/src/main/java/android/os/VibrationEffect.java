...
public abstract class VibrationEffect implements Parcelable {
    ...
    public static class OneShot extends VibrationEffect implements Parcelable {
        ...
        public static final Creator<OneShot> CREATOR =
            new Creator<OneShot>() {
                @Override
    ...
    public static class Waveform extends VibrationEffect implements Parcelable {
        ...
        public static final Creator<Waveform> CREATOR =
            new Creator<Waveform>() {
                @Override
    ...
    public static class Prebaked extends VibrationEffect implements Parcelable {
        ...
        public static final Creator<Prebaked> CREATOR =
            new Creator<Prebaked>() {
                @Override
