...
public class UserManager {
     ...
     * {@link AccountManager#addAccountExplicitly programmatically} added by
     * Authenticator.
     * The default value is <code>false</code>.
     *
     * <p>From {@link Build.VERSION_CODES#N} a profile or device owner app can still
     * use {@link AccountManager} APIs to add or remove accounts when account
     ...
     * upgrades to {@link Build.VERSION_CODES#O}, the system sets it for all existing
     * managed profiles.
     *
     * <p>Key for user restrictions.
     * <p>Type: Boolean
     ...
     * 6.0 ({@linkplain Build.VERSION_CODES#M API level 23}) or higher, profile owners.
     * <p>This restriction also prevents VPNs from starting. However, in Android 7.0
     * ({@linkplain Build.VERSION_CODES#N API level 24}) or higher, the system does
     ...
     *
     * <p>In Android 8.0 ({@linkplain Build.VERSION_CODES#O API level 26}) and higher,
     ...
     * category {@link Intent#CATEGORY_BROWSABLE}, scheme http or https, and which
     ...
     * <p>Type: Boolean
     * @see DevicePolicyManager#setApplicationRestrictions(
     *      ComponentName, String, Bundle)
     ...
     * teleportations.
     *
     * <p>As of {@link Build.VERSION_CODES#LOLLIPOP}, this method can
     ...
     * Requires {@link Manifest.permission#MANAGE_USERS} permission, otherwise the caller
     ...
     * {@link Build.VERSION_CODES#N), this API required a system permission
     * in order to check other profile's status.
     * Since Android Nougat MR1 (SDK version >= 25;
     * {@link Build.VERSION_CODES#N_MR1)), the restriction has been relaxed, and now
     ...
     * Requires {@link Manifest.permission#MANAGE_USERS} permission.
     ...
     * @deprecated use {@link DevicePolicyManager#addUserRestriction(
     * ComponentName, String)} or
     * {@link DevicePolicyManager#clearUserRestriction(
     * ComponentName, String)} instead.
     */
    @Deprecated
     ...
     *                       Bundle, Activity, android.accounts.AccountManagerCallback,
     *                       Handler)}.
     ...
     *
     * <p>Requires {@link Manifest.permission#MANAGE_USERS} permission.
     *
     ...
     * Drawable, UserHandle, Rect, int)}.
     * <p>
     * If the original drawable is a BitmapDrawable and the backing bitmap is
     * mutable as per {@link Bitmap#isMutable()}, the badging
     ...
     * {@link Manifest.permission#MANAGE_USERS} permission.
     *
    ...
    public static int getMaxSupportedUsers() {
        ...
        if (Build.ID.startsWith("JVP")) return 1;
     ...
     * <li>From {@link Build.VERSION_CODES#M}, {@code Bundle} or {@code Bundle[]}
     * </ul>
     *
