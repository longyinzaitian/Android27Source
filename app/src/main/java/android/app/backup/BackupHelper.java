...
public interface BackupHelper {
     ...
     *
     * @param oldState An open, read-only {@link ParcelFileDescriptor} pointing to the
     ...
     *            write to this file.
     * @param newState An open, read/write {@link ParcelFileDescriptor} pointing to an
    ...
    /**
     * Called by {@link BackupAgentHelper BackupAgentHelper}
     ...
     * {@link BackupDataInputStream#size() size()} bytes from
     * <code>data</code>.</p>
     *
     ...
     * file descriptor.</p>
     *
     * @param newState A {@link ParcelFileDescriptor} to which the new state will be
     * written.
     */
