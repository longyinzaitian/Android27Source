 ...
 * {@link VERSION_CODES#HONEYCOMB}, a version of the API
...
public class Fragment implements ComponentCallbacks2, OnCreateContextMenuListener {
     ...
     * if {@link #isStateSaved()} would return true. Prior to {@link VERSION_CODES#O},
     ...
     *
     * <p>If your app's <code>targetSdkVersion</code> is {@link VERSION_CODES#M}
     * or lower, child fragments being restored from the savedInstanceState are restored after
     * <code>onCreate</code> returns. When targeting {@link VERSION_CODES#N} or
