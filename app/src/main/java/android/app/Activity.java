 ...
 * </ul>
 *
 * <p>To be of use with {@link Context#startActivity Context.startActivity()}, all
 ...
 * <h3>Fragments</h3>
 *
 * <p>Starting with {@link Build.VERSION_CODES#HONEYCOMB}, Activity
 ...
 * to {@link Activity#onCreate} through to a single final call
 * to {@link Activity#onDestroy}.  An activity will do all setup
 ...
 * {@link Activity#onStart} until a corresponding call to
 * {@link Activity#onStop}.  During this time the user can see the
 ...
 * {@link Activity#onResume} until a corresponding call to
 * {@link Activity#onPause}.  During this time the activity is
 ...
 * activities will implement {@link Activity#onCreate}
 * to do their initial setup; many will also implement
 * {@link Activity#onPause} to commit changes to data and
 ...
 *
 *     <tbody>
 *     <tr><td colspan="3" align="left" border="0">{@link Activity#onCreate onCreate()}</td>
 ...
 *         <td colspan="2" align="left" border="0">{@link Activity#onRestart onRestart()}</td>
 ...
 *     </tr>
 *
 *     <tr><td colspan="2" align="left" border="0">{@link Activity#onStart onStart()}</td>
 ...
 *         <td align="left" border="0">{@link Activity#onResume onResume()}</td>
 ...
 *     </tr>
 *
 *     <tr><td align="left" border="0">{@link Activity#onPause onPause()}</td>
 ...
 *         <td align="center"><font color="#800000"><strong>Pre-{@link Build.VERSION_CODES#HONEYCOMB}</strong></font></td>
 *         <td align="center"><code>onResume()</code> or<br>
 *                 <code>onStop()</code></td>
 *     </tr>
 *
 *     <tr><td colspan="2" align="left" border="0">{@link Activity#onStop onStop()}</td>
 ...
 *     </tr>
 *
 *     <tr><td colspan="3" align="left" border="0">{@link Activity#onDestroy onDestroy()}</td>
 ...
 * applications targeting platforms starting with {@link Build.VERSION_CODES#HONEYCOMB}
 ...
 * will come back through your {@link Activity#onActivityResult}
 * method.</p>
 *
 ...
 * {@link Build.VERSION_CODES#GINGERBREAD}, if the Activity
...
public class Activity extends ContextThemeWrapper
     ...
     *
     * Calls {@link #onSaveInstanceState(Bundle)} and
     * {@link #restoreManagedDialogs(Bundle)}.
     *
     ...
     *
     * Calls {@link #onSaveInstanceState(Bundle)}
     * and {@link #saveManagedDialogs(Bundle)}.
     *
    ...
    /**
     * @deprecated As of {@link Build.VERSION_CODES#GINGERBREAD}
     * this is a no-op.
     * @hide
     */
    @Deprecated
     ...
     * set by default to {@link LayoutParams#MATCH_PARENT}. To use
     * your own layout parameters, invoke
     * {@link #setContentView(View, LayoutParams)}
     * instead.
     *
     ...
     *
     * <p>See {@link SearchManager android.app.SearchManager} for more details.
     *
     * @see #setDefaultKeyMode
     */
     ...
     * {@link ActivityManager.StackId#FREEFORM_WORKSPACE_STACK_ID} to
     * {@link ActivityManager.StackId#FULLSCREEN_WORKSPACE_STACK_ID} stack.
     *
     * @hide
     */
    @Override
     ...
     *
     * <p>As of {@link Build.VERSION_CODES#GINGERBREAD}, this function
     ...
     * {@link Window#setFeatureDrawableResource}.
     */
    ...
    /**
     * Convenience for calling
     * {@link Window#setFeatureDrawableUri}.
     */
    ...
    /**
     * Convenience for calling
     * {@link Window#setFeatureDrawable(int, Drawable)}.
     */
    ...
    /**
     * Convenience for calling
     * {@link Window#setFeatureDrawableAlpha}.
     */
     ...
     * caller.
     *
     * <p>As of {@link Build.VERSION_CODES#GINGERBREAD}, the Intent
     ...
     *
     * @see #convertToTranslucent(Activity.TranslucentConversionListener,
     * ActivityOptions)
     ...
     * Activity#convertToTranslucent(Activity.TranslucentConversionListener,
     * ActivityOptions)}
     *
     * @hide
     */
     ...
     * <p>
     * Also note that in comparison to {@link WindowManager.LayoutParams#FLAG_SECURE},
