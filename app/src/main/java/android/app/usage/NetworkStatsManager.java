 ...
 * discrete bins of time called 'Buckets'. See {@link Bucket} for details.
 * <p />
 ...
 * be {@link Bucket#STATE_ALL}, all Bucket's metered is going to be
 * {@link Bucket#METERED_ALL}, and all Bucket's roaming is going to be
 * {@link Bucket#ROAMING_ALL}.
 * <p />
...
public class NetworkStatsManager {
     ...
     * {@link Bucket#STATE_ALL}, uid {@link Bucket#UID_ALL},
     * tag {@link Bucket#TAG_NONE}, metered {@link Bucket#METERED_ALL},
     * and roaming {@link Bucket#ROAMING_ALL}.
     *
     ...
     * and 'endTime' parameters. State is going to be {@link Bucket#STATE_ALL},
     * uid {@link Bucket#UID_ALL}, tag {@link Bucket#TAG_NONE},
     * metered {@link Bucket#METERED_ALL}, and roaming
     * {@link Bucket#ROAMING_ALL}.
     *
     * @param networkType As defined in {@link ConnectivityManager}, e.g.
     *            {@link ConnectivityManager#TYPE_MOBILE}, {@link ConnectivityManager#TYPE_WIFI}
     ...
     * 'endTime' parameters. State is going to be {@link Bucket#STATE_ALL}, uid the
     * same as the 'uid' parameter and tag the same as 'tag' parameter. metered is going to be
     * {@link Bucket#METERED_ALL}, and roaming is going to be
     * {@link Bucket#ROAMING_ALL}.
     ...
     * @param tag TAG of interest. Use {@link Bucket#TAG_NONE} for no tags.
     ...
     * 'startTime' and 'endTime' parameters. State is going to be
     * {@link Bucket#STATE_ALL}, uid will vary,
     * tag {@link Bucket#TAG_NONE}, metered is going to be
     * {@link Bucket#METERED_ALL}, and roaming is going to be
     * {@link Bucket#ROAMING_ALL}.
     * <p>Only includes buckets that atomically occur in the inclusive time range. Doesn't
     * interpolate across partial buckets. Since bucket length is in the order of hours, this
