...
/**
 * A result returned from {@link UsageStatsManager#queryEvents(long, long)}
 * from which to read {@link Event} objects.
 */
public final class UsageEvents implements Parcelable {
    ...
    /**
     * Retrieve the next {@link Event} from the collection and put the
     * resulting data into {@code eventOut}.
     *
     * @param eventOut The {@link Event} object that will receive the
     *                 next event data.
