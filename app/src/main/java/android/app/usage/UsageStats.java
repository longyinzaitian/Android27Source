...
public final class UsageStats implements Parcelable {
    ...
    /**
     * Get the beginning of the time range this {@link UsageStats} represents,
    ...
    /**
     * Get the end of the time range this {@link UsageStats} represents,
     * measured in milliseconds since the epoch.
     * <p/>
     * See {@link System#currentTimeMillis()}.
     */
     ...
     * @throws IllegalArgumentException if the package names of the two
