 ...
 * services are provided through methods in {@link Activity Activity}
 * and the {@link Intent#ACTION_SEARCH ACTION_SEARCH}
 * {@link Intent Intent}.
 *
...
public class SearchManager
    ...
    /**
     * Intent extra data key: Use {@link Intent#getBundleExtra
    ...
    /**
     * Intent extra data key: Use this key with Intent.ACTION_SEARCH and
     * {@link Intent#getIntExtra content.Intent.getIntExtra()}
    ...
    /**
     * Intent extra data key: Use this key with Intent.ACTION_SEARCH and
     * {@link Intent#getStringExtra content.Intent.getStringExtra()}
     ...
     * </ul>
     *
     * See {@link ContentResolver#openAssetFileDescriptor(Uri, String)}
     ...
     * {@link Intent#ACTION_SEARCH ACTION_SEARCH}, optional otherwise.</i>  If this
     ...
     * {@link Activity#onSearchRequested Activity.onSearchRequested()} or
     * {@link Activity#startSearch Activity.startSearch()}.
     *
