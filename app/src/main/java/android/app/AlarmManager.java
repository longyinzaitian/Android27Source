 ...
 * called {@link Context#startService Context.startService()}, it
 ...
 * ({@link Build.VERSION_CODES#KITKAT}) alarm delivery is inexact:
...
public class AlarmManager {
     ...
     * etc) it is easier and much more efficient to use {@link Handler}.</b>
     ...
     * you registered with {@link Context#registerReceiver}
     ...
     * {@link Handler}.</b>  If there is already an alarm scheduled
    ...
    public static final class AlarmClockInfo implements Parcelable {
         ...
         * {@link PendingIntent#send(Context, int, Intent)
         * PendingIntent.send()} and {@link Intent#fillIn Intent.fillIn()}
         * for details.
         */
