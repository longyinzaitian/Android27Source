...
/**
 * Container of data passed to the {@link JobScheduler} fully encapsulating the
...
public class JobInfo implements Parcelable {
     ...
     * {@link Builder#setBackoffCriteria(long, int)}
    ...
    public static final class Builder {
         ...
         * jobs, doing so will throw an {@link IllegalArgumentException} when
         ...
         * persisted jobs, doing so will throw an {@link IllegalArgumentException} when
         * {@link Builder#build()} is called.</p>
         *
         ...
         * throw an {@link IllegalArgumentException} when
