 ...
 * <p>
 * See {@link JobInfo} for more description of the types of jobs that can be run
 ...
 * system will execute this job on your application's {@link JobService}.
...
public abstract class JobScheduler {
     ...
     * {@link JobInfo.Builder JobInfo.Builder} for more detail on the sorts of jobs
     * you can schedule.
