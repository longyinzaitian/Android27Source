...
/**
 * Helper for implementing a {@link Service} that interacts with
 ...
 * {@link Service} that interact with {@link JobScheduler} as well as
...
public abstract class JobServiceEngine {
     ...
     * {@link #onStartJob(JobParameters)}.
     */
    private static final int MSG_EXECUTE_JOB = 0;
    /**
     * Message that will result in a call to {@link #onStopJob(JobParameters)}.
     */
