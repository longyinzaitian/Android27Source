 ...
 * an intent inside a {@link PendingIntent} that is sent.
 * Always use {@link Builder} to create instances of this class.
 * <p class="note"> See
 ...
 *         .build();</pre>
 *
 * <p>When the {@link PendingIntent} is fired, the intent inside will contain the
...
public final class RemoteInput implements Parcelable {
     ...
     * {@link #getResultsFromIntent} when the {@link PendingIntent} is sent.
     */
