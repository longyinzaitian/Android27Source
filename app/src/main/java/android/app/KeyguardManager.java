...
public class KeyguardManager {
     ...
     * {@link Activity#startActivityForResult(Intent, int)} and check for
     * {@link Activity#RESULT_OK} if the user successfully completes the challenge.
     *
    ...
    public class KeyguardLock {
         ...
         *
         * A good place to call this is from {@link Activity#onResume()}
         *
         ...
         *
         * A good place to call this is from {@link Activity#onPause()}
         *
         * Note: This call has no effect while any {@link android.app.admin.DevicePolicyManager}
         * is enabled that requires a password.
         *
     ...
     * calling {@link Context#getSystemService(String) Context.getSystemService()}.
     * This class is wrapped by {@link KeyguardManager KeyguardManager}.
