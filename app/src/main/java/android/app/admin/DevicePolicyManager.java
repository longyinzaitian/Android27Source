...
public class DevicePolicyManager {
     ...
     * previous state.
     *
     * <p>If launched with {@link Activity#startActivityForResult(Intent, int)} a
     * result code of {@link Activity#RESULT_OK} implies that the synchronous part of
     * the provisioning flow was successful, although this doesn't guarantee the full flow will
     * succeed. Conversely a result code of {@link Activity#RESULT_CANCELED} implies
     ...
     * Must be started with {@link Activity#startActivityForResult(Intent, int)}.
     *
     ...
     *
     * <p>A result code of {@link Activity#RESULT_OK} implies that the synchronous part
    ...
    /**
     * A {@link Parcelable} extra of type {@link PersistableBundle} that
     ...
     * properties will be converted into a {@link PersistableBundle} and passed to the
     ...
     * {@link PackageManager#getPackageArchiveInfo} with flag
     ...
     * {@link DeviceAdminReceiver#onPasswordFailed(Context, Intent)} instead. Do not
     ...
     * @see UserHandle
     * @return the {@link UserHandle} object for the created user, or {@code null} if the
     ...
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
     * @param key The key of the restriction. See the constants in {@link UserManager}
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     * @see #removeCrossProfileWidgetProvider(ComponentName, String)
     * @see #getCrossProfileWidgetProviders(ComponentName)
     */
     ...
     * {@link #addCrossProfileWidgetProvider( ComponentName, String)}.
     * <p>
     * <strong>Note:</strong> By default no widget provider package is white-listed.
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     * @see #addCrossProfileWidgetProvider(ComponentName, String)
     * @see #getCrossProfileWidgetProviders(ComponentName)
     */
     ...
     * {@link KeyguardManager#createConfirmDeviceCredentialIntent}.
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
