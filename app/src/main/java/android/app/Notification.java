 ...
 * the user using the {@link NotificationManager}.
 *
 * <p>The {@link Builder Notification.Builder} has been added to make it
...
public class Notification implements Parcelable
{
     ...
     * </ul>
     *
     * For apps targeting {@link Build.VERSION_CODES#N} and above, this time is not shown
     * anymore by default and must be opted into by using
     * {@link Builder#setShowWhen(boolean)}
     */
    public long when;
     ...
     * Starting with {@link Build.VERSION_CODES#O}, the number may be displayed as a
     ...
     * {@link Intent#FLAG_ACTIVITY_NEW_TASK} flag, which requires
     ...
     * </p>
     *
     * @see Builder#setFullScreenIntent
     */
     ...
     * to {@link Builder}; a custom RemoteViews can optionally be
     * supplied with {@link Builder#setCustomContentView(RemoteViews)}.
     */
    @Deprecated
     ...
     * inputs to {@link Builder}; a custom RemoteViews can optionally be
     * supplied with {@link Builder#setCustomBigContentView(RemoteViews)}.
     */
    @Deprecated
     ...
     * inputs to {@link Builder}; a custom RemoteViews can optionally be
     * supplied with {@link Builder#setCustomHeadsUpContentView(RemoteViews)}.
     */
    @Deprecated
    ...
    /**
     * Accent color (an ARGB integer like the constants in {@link Color})
     ...
     * {@link Style} used to create this notification.
     */
    ...
    /**
     * {@link #extras} key: A
     * {@link MediaSession.Token} associated with a
     * {@link MediaStyle} notification.
     */
     ...
     * direct replies
     * {@link MessagingStyle} notification. This extra is a
     * {@link CharSequence}
     */
    ...
    /**
     * {@link #extras} key: an array of {@link MessagingStyle.Message}
     * bundles provided by a
     * {@link MessagingStyle} notification. This extra is a parcelable
     * array of bundles.
     */
     ...
     * {@link MessagingStyle#addHistoricMessage historic}
     * {@link MessagingStyle.Message} bundles provided by a
     * {@link MessagingStyle} notification. This extra is a parcelable
     * array of bundles.
     */
     ...
     * or {@link Notification.Builder#addAction(Action)}
     * to attach actions.
     */
    public static class Action implements Parcelable {
        ...
        /** Keep in sync with {@link Builder#Builder(Action)}! */
    ...
    public void setLatestEventInfo(Context context,
        ...
        final Builder builder = new Builder(context, this);
    ...
    public static class Builder {
        ...
        /**
         * @deprecated use {@link Builder#Notification.Builder(Context, String)}
         ...
         *
         * For apps targeting {@link Build.VERSION_CODES#N} and above, this time is not
         ...
         * in the content view.
         * For apps targeting {@link Build.VERSION_CODES#N} and above, this defaults to
         ...
         *
         * <p>As of {@link Build.VERSION_CODES#N} this information is displayed in the
         * notification header area.
         *
         * On Android versions before {@link Build.VERSION_CODES#N}
         ...
         * For legacy apps targeting a version below {@link Build.VERSION_CODES#N} this
         ...
         *
         * As of {@link Build.VERSION_CODES#HONEYCOMB}, if this field is unset and you
         ...
         *
         * See {@link AudioManager} for the <code>STREAM_</code> constants.
         *
        ...
        public static Notification maybeCloneStrippedForDelivery(Notification n, boolean isLowRam) {
            ...
            if (isLowRam) {
                clone.extras.remove(TvExtender.EXTRA_TV_EXTENDER);
    ...
    /**
     * An object that can apply a rich notification style to a {@link Builder}
     * object.
     */
    public static abstract class Style {
        ...
        /**
         * Calls {@link Builder#build()} on the Builder this Style is
         * attached to.
         *
     ...
     * {@link Action}s specified with
     * {@link Builder#addAction(Action) addAction} will be
     * shown as icon-only pushbuttons, suitable for transport controls. The Bitmap given to
     * {@link Builder#setLargeIcon(Bitmap) setLargeIcon()} will be
     ...
     * category using {@link Builder#setCategory(String) setCategory()}.
     * <p>
     * Finally, if you attach a {@link MediaSession.Token} using
     * {@link MediaStyle#setMediaSession(MediaSession.Token)},
     * the System UI can identify this as a notification representing an active media session
     * and respond accordingly (by showing album artwork in the lockscreen, for example).
     *
     * <p>
     * Starting at {@link Build.VERSION_CODES#O Android O} any notification that has a
     * media session attached with {@link #setMediaSession(MediaSession.Token)} will be colorized.
     * You can opt-out of this behavior by using {@link Builder#setColorized(boolean)}.
     * <p>
     *
     ...
     *
     * @see Notification#bigContentView
     * @see Builder#setColorized(boolean)
     */
    public static class MediaStyle extends Style {
        ...
        /**
         * Attach a {@link MediaSession.Token} to this Notification
     ...
     * notification by using {@link Builder#setColorized(boolean)}.
     * <p>
     * To use this style with your Notification, feed it to
     * {@link Builder#setStyle(Style)} like so:
     * <pre class="prettyprint">
     ...
     *  {@link CarExtender}.
     *  <li>Call {@link Notification.Builder#extend(Extender)}
    ...
    public static final class CarExtender implements Extender {
         ...
         * the {@link Notification.Builder#extend(Extender)}
         ...
         * specified by {@link Notification.Builder#setLargeIcon(Bitmap)}
         *
     ...
     *
     * <ol>
     *  <li>Create an {@link Builder}, setting any desired properties.
