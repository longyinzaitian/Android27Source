...
public class AppWidgetProviderInfo implements Parcelable {
     ...
     *
     * @deprecated Use {@link #loadLabel(PackageManager)}.
     */
    @Deprecated
    public String label;
     ...
     * provide a desired density such as {@link DisplayMetrics#DENSITY_LOW}
     * {@link DisplayMetrics#DENSITY_MEDIUM}, etc. If no density is
     ...
     *         {@link DisplayMetrics#densityDpi}.
    ...
    public static final Creator<AppWidgetProviderInfo> CREATOR
            = new Creator<AppWidgetProviderInfo>()
    {
