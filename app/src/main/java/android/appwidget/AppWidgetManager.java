...
public class AppWidgetManager {
     ...
     * <p>
     * The value will be an {@link ComponentName}.
     */
     ...
     * <p>
     * The value will be a {@link UserHandle}.
     */
    public static final String EXTRA_APPWIDGET_PROVIDER_PROFILE = "appWidgetProviderProfile";

    /**
     * An intent extra to pass to the AppWidget picker containing a {@link List} of
    ...
    /**
     * An intent extra to pass to the AppWidget picker containing a {@link List} of
     * {@link Bundle} objects to mix in to the list of AppWidgets that are
     * installed.  It will be added to the extras object on the {@link Intent}
     ...
     * {@link AppWidgetManager#bindAppWidgetId AppWidgetManager.bindAppWidgetId()}.
     *
