...
public class StateListAnimator implements Cloneable {
    ...
    /**
     * Returns the current {@link Animator} which is started because of a state
     * change.
     *
    ...
    /**
     * Return a {@link ConstantState} instance that holds the shared state of
     * this Animator.
     * <p>
     ...
     * cached.
     *
     * @return The {@link ConstantState} associated to this Animator.
     * @see ConstantState
     * @see #clone()
     * @hide
     */
