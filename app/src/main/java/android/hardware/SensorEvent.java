...
/**
 * This class represents a {@link Sensor Sensor} event and
...
public class SensorEvent {
     ...
     * which {@link Sensor sensor} type is being monitored (see
     * also {@link SensorEvent} for a definition of the coordinate system used).
     * </p>
     *
     * <h4>{@link Sensor#TYPE_ACCELEROMETER
     ...
     *
     *
     * <h4>{@link Sensor#TYPE_MAGNETIC_FIELD
     * Sensor.TYPE_MAGNETIC_FIELD}:</h4>
     * All values are in micro-Tesla (uT) and measure the ambient magnetic field
     * in the X, Y and Z axis.
     *
     * <h4>{@link Sensor#TYPE_GYROSCOPE Sensor.TYPE_GYROSCOPE}:
     ...
     * </p>
     * <h4>{@link Sensor#TYPE_LIGHT Sensor.TYPE_LIGHT}:</h4>
     * <ul>
     * <li>values[0]: Ambient light level in SI lux units </li>
     * </ul>
     *
     * <h4>{@link Sensor#TYPE_PRESSURE Sensor.TYPE_PRESSURE}:</h4>
     * <ul>
     * <li>values[0]: Atmospheric pressure in hPa (millibar) </li>
     * </ul>
     *
     * <h4>{@link Sensor#TYPE_PROXIMITY Sensor.TYPE_PROXIMITY}:
     * </h4>
     *
     * <ul>
     ...
     * {@link Sensor#getMaximumRange() maximum range} value in
     * the <i>far</i> state and a lesser value in the <i>near</i> state.
     * </p>
     *
     *  <h4>{@link Sensor#TYPE_GRAVITY Sensor.TYPE_GRAVITY}:</h4>
     ...
     *
     *  <h4>{@link Sensor#TYPE_LINEAR_ACCELERATION Sensor.TYPE_LINEAR_ACCELERATION}:</h4>
     ...
     *
     *  <h4>{@link Sensor#TYPE_ROTATION_VECTOR Sensor.TYPE_ROTATION_VECTOR}:</h4>
     ...
     * </p>
     *
     * <h4>{@link Sensor#TYPE_ORIENTATION
     ...
     * </p>
     *
     * <h4>{@link Sensor#TYPE_RELATIVE_HUMIDITY
     ...
     * </pre>
     *
     * <h4>{@link Sensor#TYPE_AMBIENT_TEMPERATURE Sensor.TYPE_AMBIENT_TEMPERATURE}:
     * </h4>
     *
     * <ul>
     ...
     *
     *
     * <h4>{@link Sensor#TYPE_MAGNETIC_FIELD_UNCALIBRATED
     * Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED}:</h4>
     * Similar to {@link Sensor#TYPE_MAGNETIC_FIELD},
     ...
     * field.
     * </p>
     * <h4> {@link Sensor#TYPE_GAME_ROTATION_VECTOR
     * Sensor.TYPE_GAME_ROTATION_VECTOR}:</h4>
     * Identical to {@link Sensor#TYPE_ROTATION_VECTOR} except that it
     ...
     * may drift somewhat over time. See {@link Sensor#TYPE_ROTATION_VECTOR}
     * for a detailed description of the values. This sensor will not have
     * the estimated heading accuracy value.
     * </p>
     *
     * <h4> {@link Sensor#TYPE_GYROSCOPE_UNCALIBRATED
     ...
     * </ul>
     *
     *   <h4>{@link Sensor#TYPE_STATIONARY_DETECT
     ...
     * </ul>
     *
     *   <h4>{@link Sensor#TYPE_MOTION_DETECT
     ...
     * </ul>
     *
     *   <h4>{@link Sensor#TYPE_HEART_BEAT
     ...
     * </p>
     *
     * <h4>{@link Sensor#TYPE_LOW_LATENCY_OFFBODY_DETECT
     ...
     * </p>
     *
     * <h4>{@link Sensor#TYPE_ACCELEROMETER_UNCALIBRATED
     * Sensor.TYPE_ACCELEROMETER_UNCALIBRATED}:</h4> All values are in SI
     * units (m/s^2)
     *
     * Similar to {@link Sensor#TYPE_ACCELEROMETER},
     ...
     * axes similar to the  {@link Sensor#TYPE_ACCELEROMETER},
    ...
    /**
     * The accuracy of this event. See {@link SensorManager
