...
public class LegacyMetadataMapper {
     ...
     */
    public static CameraCharacteristics createCharacteristics(Parameters parameters,
            CameraInfo info) {
     ...
     * and {@code info}
     *
     * @param parameters A string parseable by {@link Parameters#unflatten}
     * @param info Camera info with camera facing direction and angle of orientation
     * @return static camera characteristics for a camera device
     *
     * @throws NullPointerException if any of the args were {@code null}
         ...
         */
        {
            ...
            for (int[] r : fpsRanges) {
                ranges[i++] = Range.create(
                        (int) Math.floor(r[Parameters.PREVIEW_FPS_MIN_INDEX] / 1000.0),
                        (int) Math.ceil(r[Parameters.PREVIEW_FPS_MAX_INDEX] / 1000.0));
            }
    ...
    private static void mapControlAwb(CameraMetadataNative m, Parameters p) {
...

        {
            ...
            String[] wbModeStrings = new String[] {
                    ...
                    Parameters.WHITE_BALANCE_FLUORESCENT             ,
                    Parameters.WHITE_BALANCE_WARM_FLUORESCENT        ,
                    Parameters.WHITE_BALANCE_DAYLIGHT                ,
                    Parameters.WHITE_BALANCE_CLOUDY_DAYLIGHT         ,
                    Parameters.WHITE_BALANCE_TWILIGHT                ,
    ...
    private static void mapFlash(CameraMetadataNative m, Parameters p) {
        ...
        if (supportedFlashModes != null) {
            ...
            flashAvailable = !ListUtils.listElementsEqualTo(
                    supportedFlashModes, Parameters.FLASH_MODE_OFF);
        }
...
//                    CaptureResult.STATISTICS_FACES                                 ,
    ...
    private static int convertAntiBandingMode(String mode) {
        ...
        switch (mode) {
            case Parameters.ANTIBANDING_OFF: {
                return CONTROL_AE_ANTIBANDING_MODE_OFF;
            }
            case Parameters.ANTIBANDING_50HZ: {
                return CONTROL_AE_ANTIBANDING_MODE_50HZ;
            }
            case Parameters.ANTIBANDING_60HZ: {
                return CONTROL_AE_ANTIBANDING_MODE_60HZ;
            }
            case Parameters.ANTIBANDING_AUTO: {
