...
public final class CameraManager {
     ...
     *             the current thread's {@link Looper looper}.
     *
     ...
     * {@link CameraDevice.StateCallback#onDisconnected} callback.</p>
     *
     ...
     *             {@code null} to use the current thread's {@link Looper looper}.
     *
     * @throws CameraAccessException if the camera is disabled by device policy,
     ...
     * {@link TorchCallback#onTorchModeChanged} will be invoked.
     ...
     * {@link TorchCallback#onTorchModeUnavailable} will be invoked). Also,
     * other applications are free to call {@link #setTorchMode} to turn off the torch mode (
     * {@link TorchCallback#onTorchModeChanged} will be invoked). If the latest
    ...
    public static abstract class TorchCallback {
         ...
         * turned off before {@link TorchCallback#onTorchModeUnavailable} is
