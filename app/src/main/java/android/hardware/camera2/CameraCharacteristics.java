...
public final class CameraCharacteristics extends CameraMetadata<CameraCharacteristics.Key<?>> {
     ...
     * to use with {@link CaptureRequest }.</p>
    ...
    /**
     * <p>A list of all keys that the camera device has available
     * to use with {@link CaptureResult }.</p>
    ...
    /**
     * <p>A list of all keys that the camera device has available
     * to use with {@link CameraCharacteristics }.</p>
     ...
     * </tbody>
     * </table>
     * <p>Refer to {@link CameraCharacteristics#REQUEST_AVAILABLE_CAPABILITIES android.request.availableCapabilities} and {@link CameraDevice#createCaptureSession } for additional mandatory
     ...
     * ranges defined in individual {@link CameraCharacteristics } entries.</p>
