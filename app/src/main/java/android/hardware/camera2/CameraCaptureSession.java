 ...
 * {@link StateCallback#onConfigured onConfigured} callback. If configuration
 * cannot be completed, then the
 * {@link StateCallback#onConfigureFailed onConfigureFailed} is called, and the
...
public abstract class CameraCaptureSession implements AutoCloseable {
     ...
     *
     * <p>{@link CameraCharacteristics#INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY LEGACY}
     ...
     * target {@link Surface surfaces}. The target surfaces (set with
