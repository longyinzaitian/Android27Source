...
public abstract class SensorEventCallback implements SensorEventListener2 {
     ...
     *
     * @see SensorEventListener#onAccuracyChanged(Sensor, int)
     */
    @Override
     ...
     *
     * @see SensorEventListener2#onFlushCompleted(Sensor)
     */
    @Override
     ...
     *
     * @param info A {@link SensorAdditionalInfo SensorAdditionalInfo} frame
