...
public class SoundTrigger {
    ...
    public static class KeyphraseSoundModel extends SoundModel implements Parcelable {
        ...
        public static final Creator<KeyphraseSoundModel> CREATOR
                = new Creator<KeyphraseSoundModel>() {
    ...
    public static class GenericSoundModel extends SoundModel implements Parcelable {
        ...
        public static final Creator<GenericSoundModel> CREATOR
    ...
    public static class KeyphraseRecognitionExtra implements Parcelable {
        ...
        public static final Creator<KeyphraseRecognitionExtra> CREATOR
                = new Creator<KeyphraseRecognitionExtra>() {
    ...
    public static class KeyphraseRecognitionEvent extends RecognitionEvent {
        ...
        public static final Creator<KeyphraseRecognitionEvent> CREATOR
                = new Creator<KeyphraseRecognitionEvent>() {
    ...
    public static class GenericRecognitionEvent extends RecognitionEvent {
        ...
        public static final Creator<GenericRecognitionEvent> CREATOR
