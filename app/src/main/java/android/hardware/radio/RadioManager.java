...
public class RadioManager {
    ...
    public static class BandDescriptor implements Parcelable {
        ...
        public static final Creator<BandDescriptor> CREATOR
                = new Creator<BandDescriptor>() {
    ...
    public static class FmBandDescriptor extends BandDescriptor {
        ...
        public static final Creator<FmBandDescriptor> CREATOR
                = new Creator<FmBandDescriptor>() {
    ...
    public static class AmBandDescriptor extends BandDescriptor {
        ...
        public static final Creator<AmBandDescriptor> CREATOR
                = new Creator<AmBandDescriptor>() {
    ...
    public static class BandConfig implements Parcelable {
        ...
        public static final Creator<BandConfig> CREATOR
                = new Creator<BandConfig>() {
    ...
    public static class FmBandConfig extends BandConfig {
        ...
        public static final Creator<FmBandConfig> CREATOR
                = new Creator<FmBandConfig>() {
    ...
    public static class AmBandConfig extends BandConfig {
        ...
        public static final Creator<AmBandConfig> CREATOR
                = new Creator<AmBandConfig>() {
     ...
     * {@link RadioTuner#getProgramInformation(ProgramInfo[])} */
