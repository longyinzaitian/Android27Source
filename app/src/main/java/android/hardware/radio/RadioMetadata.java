...
public final class RadioMetadata implements Parcelable {
    ...
    public static final class Clock implements Parcelable {
        ...
        public static final Creator<Clock> CREATOR
                = new Creator<Clock>() {
    ...
    public static final Creator<RadioMetadata> CREATOR =
            new Creator<RadioMetadata>() {
                @Override
    ...
    public static final class Builder {
        ...
        /**
         * Put a {@link Clock} into the meta data. Custom keys may be used, but if the
    ...
    int putClockFromNative(int nativeKey, long utcEpochSeconds, int timezoneOffsetInMinutes) {
        ...
        mBundle.putParcelable(key, new Clock(
