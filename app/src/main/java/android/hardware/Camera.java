 ...
 *
 * <li>When you want, call {@link #takePicture(ShutterCallback,
 * PictureCallback, PictureCallback, PictureCallback)} to
...
public class Camera {
     ...
     * they are displayed.
     *
     * @see #setPreviewCallback(PreviewCallback)
    ...
    public interface PreviewCallback
    {
         ...
         * refer to the equations in {@link Parameters#setPreviewFormat}
     ...
     *
     * <p>If {@link #setPreviewCallback(PreviewCallback)},
     * {@link #setOneShotPreviewCallback(PreviewCallback)}, or
     * {@link #setPreviewCallbackWithBuffer(PreviewCallback)} were
     * called, {@link PreviewCallback#onPreviewFrame(byte[], Camera)}
     ...
     * callback, {@link #setPreviewCallback(PreviewCallback)} is called,
     * or {@link #setOneShotPreviewCallback(PreviewCallback)} is
     * called.</p>
     *
     * <p>If you are using the preview data to create video or still images,
     * strongly consider using {@link android.media.MediaActionSound} to
     ...
     *
     * <p>If using the {@link ImageFormat#YV12} format, the
     ...
     * read from {@link Parameters#getPictureSize()}. Bytes per pixel
     ...
     * is used while calling {@link #takePicture(ShutterCallback,
     * PictureCallback, PictureCallback, PictureCallback)}.
     *
     ...
     *
     * @see #takePicture(ShutterCallback,
     * PictureCallback, PictureCallback, PictureCallback)}.
     *
     * {@hide}
     */
     ...
     * {@link Allocation Allocation} to use as a
     ...
     *   flag {@link Allocation#USAGE_IO_INPUT} will always
    ...
    /**
     * <p>Set an {@link Allocation Allocation} as the
     ...
     * {@link Allocation#setIoInputNotificationHandler Allocation.setIoInputNotificationHandler}. To
     * update the frame currently accessible from the Allocation to the latest
     * preview frame, call
     * {@link Allocation#ioReceive Allocation.ioReceive}.</p>
     *
    ...
    public interface AutoFocusCallback
    {
         ...
         * @param camera  the Camera service object
         * @see Parameters#setAutoExposureLock(boolean)
         * @see Parameters#setAutoWhiteBalanceLock(boolean)
         */
     ...
     *
     * <p>Auto-exposure lock {@link Parameters#getAutoExposureLock()}
     * and auto-white balance locks {@link Parameters#getAutoWhiteBalanceLock()}
     ...
     * image capture with {@link #takePicture(ShutterCallback,
     * PictureCallback, PictureCallback)}, will not change the
     ...
     * {@link OnZoomChangeListener#onZoomChange(int, boolean, Camera)}
     ...
     *
     * <p>After calling {@link #takePicture(ShutterCallback, PictureCallback,
     ...
     * {@link Camera#setParameters(Parameters)}. For example, after
     * {@link Parameters#setWhiteBalance} is called, white balance is not
     * actually changed until {@link Camera#setParameters(Parameters)}
    ...
    public class Parameters {
         ...
         * call {@link #takePicture(ShutterCallback,
         * PictureCallback, PictureCallback)} in this mode but the
         ...
         * {@link ImageFormat#NV21} or
         * {@link ImageFormat#YV12} is used, since
         ...
         * {@link ImageFormat#YV12}. For camera callback data,
         ...
         *   one of the {@link ImageFormat} constants.  (E.g.,
         *   <var>ImageFormat.NV21</var> (default), or
         *   <var>ImageFormat.YV12</var>)
         *
         * @see ImageFormat
         * @see Parameters#getSupportedPreviewFormats
         */
        ...
        /**
         * Gets the supported preview formats. {@link ImageFormat#NV21}
         * is always supported. {@link ImageFormat#YV12}
         ...
         * {@link CameraInfo}. The value from
         ...
         * {@link #takePicture(ShutterCallback, PictureCallback,
         * PictureCallback, PictureCallback)}. Using this hint can
         ...
         * can call {@link #takePicture(ShutterCallback,
         * PictureCallback, PictureCallback,
         * PictureCallback)} during recording. Applications do not need
