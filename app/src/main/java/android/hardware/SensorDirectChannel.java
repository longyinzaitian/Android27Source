 ...
 * {@link SensorManager#createDirectChannel(MemoryFile)} or
 * {@link SensorManager#createDirectChannel(HardwareBuffer)}
...
public final class SensorDirectChannel implements Channel {
     ...
     * rateLevel other than {@link SensorDirectChannel#RATE_STOP}. Sensor events
     ...
     * SensorDirectChannel#RATE_STOP}. If the sensor parameter is left to be null,
     ...
     *
     * @param sensor A {@link Sensor} object to denote sensor to be operated.
     * @param rateLevel rate level defined in {@link SensorDirectChannel}.
    ...
    /**
     * This function encode handle information in {@link MemoryFile} into a long array to
