...
/**
 * <p>
 * SensorManager lets you access the device's {@link Sensor
 * sensors}.
 * </p>
 * <p>
...
public abstract class SensorManager {
     ...
     * {@link SensorListener SensorListener} for more details.
     *
     * @deprecated use {@link Sensor Sensor} instead.
     */
    @Deprecated
     ...
     * {@link SensorListener#onSensorChanged}
     *
     * @deprecated use {@link Sensor Sensor} instead.
     */
    @Deprecated
     ...
     * {@link Sensor#TYPE_ALL Sensor.TYPE_ALL} to get all the
     * sensors.
     *
     * <p class="note">
     ...
     * Make multiple calls to get sensors of different types or use
     * {@link Sensor#TYPE_ALL Sensor.TYPE_ALL} to get all dynamic sensors.
     *
     * <p class="note">
     * NOTE: Both wake-up and non wake-up sensors matching the given type are
     * returned. Check {@link Sensor#isWakeUpSensor()} to know the wake-up properties
    ...
    /**
     * Registers a {@link SensorEventListener SensorEventListener} for the given
     ...
     * @param samplingPeriodUs The rate {@link SensorEvent sensor events} are
     ...
     *            {@link SensorEventListener SensorEventListener2} instead.
     * @param sensor The {@link Sensor Sensor} to register to.
     ...
     * @param handler The {@link Handler Handler} the {@link SensorEvent
     ...
     * returns immediately.
     * {@link SensorEventListener2#onFlushCompleted onFlushCompleted} is called
     ...
     *
     * Use the returned {@link SensorDirectChannel} object to configure direct
     * report of sensor events. After use, call {@link SensorDirectChannel#close()}
     * to free up resource in sensor system associated with the direct channel.
     *
     * @param mem A {@link MemoryFile} shared memory object.
     * @return A {@link SensorDirectChannel} object.
     ...
     * to free up resource in sensor system associated with the direct channel.
     *
     * @param mem A {@link HardwareBuffer} shared memory object.
     * @return A {@link SensorDirectChannel} object.
     * @throws NullPointerException when mem is null.
     * @throws UncheckedIOException if not able to create channel.
     * @see SensorDirectChannel#close()
    ...
    public static abstract class DynamicSensorCallback {
         ...
         *
         * @param sensor the newly connected sensor. See {@link Sensor Sensor}.
         */
         ...
         *
         * @param sensor the disconnected sensor. See {@link Sensor Sensor}.
         */
    ...
    /**
     * Add a {@link DynamicSensorCallback
     ...
     * @param handler The {@link Handler Handler} the {@link
     *        DynamicSensorCallback
    ...
    /**
     * Remove a {@link DynamicSensorCallback
     ...
     *        {@link SensorEvent#values values} returned by a
     *        {@link SensorEvent SensorEvent} of a
     *        {@link Sensor Sensor} of type
