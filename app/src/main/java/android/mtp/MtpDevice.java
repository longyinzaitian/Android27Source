 ...
 * UsbDevice} and then use methods in this class to get information about the
...
public final class MtpDevice {
     ...
     *
     * @param device the {@link UsbDevice} for the MTP or PTP device
     */
     ...
     *
     * @param connection an open {@link UsbDeviceConnection} for the device
     ...
     * with a new {@link UsbDeviceConnection}.
     */
    public void close() {
        synchronized (mLock) {
            if (mConnection != null) {
     ...
     * This returns the same value as {@link UsbDevice#getDeviceName}
     * for the device's {@link UsbDevice}
     *
     ...
     * This returns the same value as {@link UsbDevice#getDeviceId}
     * for the device's {@link UsbDevice}
     *
