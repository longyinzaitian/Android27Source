...
public final class EphemeralResolveInfo implements Parcelable {
    ...
    public static final Creator<EphemeralResolveInfo> CREATOR
            = new Creator<EphemeralResolveInfo>() {
        @Override
    ...
    public static final class EphemeralDigest implements Parcelable {
        ...
        public static final Creator<EphemeralDigest> CREATOR =
                new Creator<EphemeralDigest>() {
            @Override
