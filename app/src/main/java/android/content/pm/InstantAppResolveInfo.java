...
public final class InstantAppResolveInfo implements Parcelable {
    ...
    public static final Creator<InstantAppResolveInfo> CREATOR
            = new Creator<InstantAppResolveInfo>() {
    ...
    public static final class InstantAppDigest implements Parcelable {
        ...
        public static final Creator<InstantAppDigest> CREATOR =
                new Creator<InstantAppDigest>() {
            @Override
