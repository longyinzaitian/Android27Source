...
public class LauncherApps {
     ...
     * a pinned app widget.
     *
     * <p>See the {@link AppWidgetManager#requestPinAppWidget} javadoc for
     * details.
     *
     * <p>
     * Use {@link #getPinItemRequest(Intent)} to get a {@link PinItemRequest} object,
     ...
     * is locked or not running.
     *
     * @throws ActivityNotFoundException failed to start shortcut. (e.g.
     ...
     * {@link AppWidgetManager#EXTRA_APPWIDGET_ID} extra.
     *
    ...
    public static final class PinItemRequest implements Parcelable {
         ...
         * {@link AppWidgetManager#requestPinAppWidget(
