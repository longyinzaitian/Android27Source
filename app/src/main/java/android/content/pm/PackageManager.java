...
public abstract class PackageManager {
    ...
    */
     ...
     * related to the {@link IntentFilter#setAutoVerify(boolean)} and
     * {@link IntentFilter#getAutoVerify()}
     *
     ...
     * This is related to the {@link IntentFilter#setAutoVerify(boolean)} and
     * {@link IntentFilter#getAutoVerify()}
     *
     * This is used by the ResolverActivity to change the status depending on what the User select
     * in the Disambiguation Dialog and also used by the Settings App for changing the default App
     ...
     * {@link Manifest.permission#DELETE_PACKAGES} permission, if the
     ...
     * lacks the {@link Manifest.permission#DELETE_CACHE_FILES} permission, if the
     * named package cannot be found, or if the named package is a "system package".
     *
     * @param packageName The name of the package to delete
     ...
     * {@link Manifest.permission#DELETE_CACHE_FILES} permission, if the named package
     ...
     * {@link Manifest.permission#INTERACT_ACROSS_USERS} permission.
     *
     * @param packageName The name of the package to delete
     ...
     * should have the {@link Manifest.permission#GET_PACKAGE_SIZE} permission.
     *
