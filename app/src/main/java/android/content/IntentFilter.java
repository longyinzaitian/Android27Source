 ...
 * and {@link Uri#getScheme} on that URI.
 ...
 * {@link Intent#getData} and {@link Uri#getSchemeSpecificPart} on that URI.
 ...
 * {@link Intent#getData} and {@link Uri#getAuthority} on that URI.
 ...
 * {@link Intent#getData} and {@link Uri#getPath} on that URI.
 *
...
public class IntentFilter implements Parcelable {
     ...
     * {@link Intent#ACTION_VIEW} and the Intent category is
     * {@link Intent#CATEGORY_BROWSABLE} and the Intent data scheme
     * is "http" or "https".
     *
     ...
     * This will check if:
     *
     * - either the Intent category is {@link Intent#CATEGORY_APP_BROWSER}
     * - either the Intent action is {@link Intent#ACTION_VIEW} and
     * the Intent category is {@link Intent#CATEGORY_BROWSABLE} and the Intent
     ...
     *
     * This will check if if the Intent action is {@link Intent#ACTION_VIEW} and
     * the Intent category is {@link Intent#CATEGORY_BROWSABLE} and the Intent
     ...
     * by {@link Uri#getSchemeSpecificPart() Uri.getSchemeSpecificPart}.
     ...
     *
     * @see #match(String, String, String, Uri , Set, String)
     */
