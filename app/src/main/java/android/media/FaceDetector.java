...
public class FaceDetector {
    ...
    /**
     * Finds all the faces found in a given {@link Bitmap}.
     * The supplied array is populated with {@link Face}s for each
     * face found. The bitmap must be in 565 format (for now).
     * 
     * @param bitmap the {@link Bitmap} graphic to be analyzed
     * @param faces  an array in which to place all found 
     *               {@link Face}s. The array must be sized equal
