 ...
 * rendered into a {@link Surface}</p>
 *
...
public class ImageReader implements AutoCloseable {
     ...
     *            must be one of the {@link ImageFormat} or
     ...
     * {@link MediaCodec} or {@link MediaRecorder} for hardware video
     ...
     * is created with the input {@link Surface} provided by the
     * {@link MediaCodec} or {@link MediaRecorder}.
     * </p>
     * <p>
     ...
     * {@link MediaCodec} / {@link MediaRecorder} for hardware video
     ...
     * </tr>
     * <tr>
     *   <td>non-{@link ImageFormat#PRIVATE PRIVATE} formats defined by
     *   {@link ImageFormat ImageFormat} or
     *   {@link PixelFormat PixelFormat}</td>
     *   <td>{@link HardwareBuffer#USAGE0_CPU_READ} or
     *   {@link HardwareBuffer#USAGE0_CPU_READ_OFTEN}</td>
     * </tr>
     * <tr>
     *   <td>{@link ImageFormat#PRIVATE}</td>
     ...
     * {@link WeakReference weak reference} to the ImageReader that provides it.</p>
     *
