...
public final class TvInputManager {
    ...
    public abstract static class SessionCallback {
         ...
         *
         * @param session A {@link Session} instance created. This can be
        ...
        /**
         * This is called when {@link Session} is released.
         * This typically happens when the process hosting the session has crashed or been killed.
         *
         * @param session A {@link Session} instance released.
         */
         ...
         * without any {@link Session#tune(Uri)} request.
         *
         * @param session A {@link Session} associated with this callback.
         ...
         */
        void onError(Session session, @RecordingError int error) {
        }
    }
    ...
    public static final class Session {
        ...
        /**
         * Sets the {@link Surface} for this session.
         *
         * @param surface A {@link Surface} used to render video.
         */
