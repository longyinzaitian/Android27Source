...
public final class TvInputInfo implements Parcelable {
     ...
     * @param iconUri The {@link Uri} to load the icon image. See
    ...
    public static TvInputInfo createTvInputInfo(Context context, ResolveInfo service,
        ...
        TvInputInfo info = new Builder(context, service)
     ...
     * @param icon The {@link Icon} to load the icon image. If it is
