...
class Utils {
     ...
     * @throws IllegalArgumentException if ranges are not distinct
     */
     ...
     * @param subdirectory One of the directories specified in {@link Environment}
    ...
    /**
     * Returns a file's display name from its {@link ContentResolver.SCHEME_FILE}
     * or {@link ContentResolver.SCHEME_CONTENT} Uri. The display name of a file
