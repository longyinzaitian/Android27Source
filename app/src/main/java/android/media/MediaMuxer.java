 ...
 *
 ...
 <p>
  ...
  the metadata's mime format. When using{@link MediaExtractor} to extract the file with
  metadata track, the mime format of the metadata will be extracted into {@link MediaFormat}.
