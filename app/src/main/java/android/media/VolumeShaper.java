...
public final class VolumeShaper implements AutoCloseable {
    ...
    /**
     * Applies the {@link Operation} to the {@code VolumeShaper}.
     *
     * Applying {@link Operation#PLAY} after {@code PLAY}
     * or {@link Operation#REVERSE} after
     * {@code REVERSE} has no effect.
     *
     * Applying {@link Operation#PLAY} when the player
    ...
    public void apply(@NonNull Operation operation) {
        /* void */ applyPlayer(new Configuration(mId), operation);
    }
     ...
     *
     * If the {@code operation} is {@link Operation#PLAY} then the
     * new curve starts immediately.
     *
     * If the {@code operation} is
     * {@link Operation#REVERSE}, then the new curve will
     ...
     * It is constructed by the {@link Builder}.
     * <p>
    ...
    public static final class Configuration implements Parcelable {
         ...
         */
        public static final Configuration LINEAR_RAMP = new Builder()
         ...
         */
        public static final Configuration CUBIC_RAMP = new Builder()
        ...
        static {
            ...
            SINE_RAMP = new Builder()
                .setInterpolatorType(INTERPOLATOR_TYPE_CUBIC)
                .setCurve(times, sines)
                .setDuration(1000)
                .build();
            SCURVE_RAMP = new Builder()
                .setInterpolatorType(INTERPOLATOR_TYPE_CUBIC)
        ...
        /**
         * Builder class for a {@link Configuration} object.
        ...
        public static final class Builder {
             ...
             * and no greater than {@link Configuration#getMaximumCurvePoints()}.
             * <p>
    ...
    public static final class Operation implements Parcelable {
        ...
        /**
         * @hide
         * {@code Builder} class for {@link Operation} object.
         *
         * Not for public use.
         */
        public static final class Builder {
            ...
            /**
             * Builds a new {@link Operation} object.
             *
    ...
    public static final class State implements Parcelable {
        ...
        /**
         * Gets the volume of the {@link State}.
