...
final public class MediaCodec {
    ...
    private class EventHandler extends Handler {
        ...
        private void handleCallback(@NonNull Message msg) {
            ...
            switch (msg.arg1) {
                ...
                case CB_ERROR:
                {
                    mCallback.onError(mCodec, (CodecException) msg.obj);
                    break;
                }
     ...
     *
     * Call this if an {@link CodecException#isRecoverable unrecoverable}
     ...
     * {@link Surface#lockCanvas(Rect)} may fail or produce
     * unexpected results.
     ...
     * @throws CodecException upon codec error. Note that some codec errors
     ...
     * The class {@link MediaExtractor} provides codec
    ...
    public final static class CryptoInfo {
        ...
        /**
         * Set the encryption pattern on a {@link CryptoInfo} instance.
         * See {@link Pattern}.
         */
    ...
    public static abstract class Callback {
         ...
         * @param info Info regarding the available output buffer {@link BufferInfo}.
         */
         ...
         *
         * @param codec The MediaCodec object.
         * @param e The {@link CodecException} object describing the error.
         */
