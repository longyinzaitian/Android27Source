...
public final class MidiManager {
     ...
     * @param handler The {@link Handler Handler} that will be used for delivering the
     ...
     *
     * @param deviceInfo a {@link MidiDeviceInfo} to open
     * @param listener a {@link OnDeviceOpenedListener} to be called
     *                 to receive the result
     * @param handler the {@link Handler Handler} that will be used for delivering
     ...
     *
     * @param bluetoothDevice a {@link BluetoothDevice} to open as a MIDI device
     * @param listener a {@link OnDeviceOpenedListener} to be called to receive the
     * result
     * @param handler the {@link Handler Handler} that will be used for delivering
     *                the result. If handler is null, then the thread used for the
     *                listener is unspecified.
