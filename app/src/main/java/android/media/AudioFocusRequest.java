 ...
 * {@link Builder#AudioFocusRequest.Builder(int)}, or
 * with {@link Builder#setFocusGain(int)} after copying an existing instance with
 * {@link Builder#AudioFocusRequest.Builder(AudioFocusRequest)}.
 *
...
public final class AudioFocusRequest {
     ...
     * @return null if no {@link OnAudioFocusChangeListener} was set.
     */
