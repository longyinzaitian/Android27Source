...
/**
 * MediaDescrambler class can be used in conjunction with {@link MediaCodec}
 * and {@link MediaExtractor} to decode media data scrambled by conditional
...
public final class MediaDescrambler implements AutoCloseable {
     ...
     * by {@link MediaExtractor or @link
     * android.media.MediaCodec#queueSecureInputBuffer} by specifying even
     * or odd key in the {@link MediaCodec.CryptoInfo#key} field.
     *
     ...
     * {@link MediaCodec.CryptoInfo} structure.
     *
     ...
     * dstBuf.position().
     * @param cryptoInfo a {@link MediaCodec.CryptoInfo} structure
