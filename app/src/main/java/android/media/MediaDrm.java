 ...
 * conjunction with {@link MediaCrypto}.  The MediaDrm APIs
 ...
 *         border="0" /></p>
 * <p>
 * The app first constructs {@link MediaExtractor} and
 * {@link MediaCodec} objects. It accesses the DRM-scheme-identifying UUID,
 ...
 * <p>
 * When the app has constructed {@link MediaExtractor},
 * {@link MediaCodec} and {@link MediaCrypto} objects,
 ...
 * <p>
 * MediaDrm methods throw {@link MediaDrmStateException}
 * when a method is called on a MediaDrm object that has had an unrecoverable failure 
 * in the DRM plugin or security hardware. 
 * {@link MediaDrmStateException} extends
 * {@link IllegalStateException} with the addition of a developer-readable
 ...
 * is active, MediaDrm methods may throw {@link MediaDrmResetException}.
 * To recover, the app must release the MediaDrm object, then create and initialize
 * a new one.
 * <p>
 * As {@link MediaDrmResetException} and
 * {@link MediaDrmStateException} both extend
 * {@link IllegalStateException}, they should be in an earlier catch()
 * block than {@link IllegalStateException} if handled separately.
 * <p>
 * <a name="Callbacks"></a>
 * <h3>Callbacks</h3>
...
public final class MediaDrm {
    ...
    public interface OnKeyStatusChangeListener
    {
         ...
         * @param md the MediaDrm object on which the event occurred
         * @param sessionId the DRM session ID on which the event occurred
         * @param keyInformation a list of {@link KeyStatus}
     ...
     *
     * @deprecated Handle provisioning via {@link NotProvisionedException}
     * instead.
     */
     ...
     * and check for {@link KeyStatus#STATUS_EXPIRED} in the {@link KeyStatus}
     * instead.
     */
