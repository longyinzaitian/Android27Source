 ...
 * {@link ByteBuffer ByteBuffers}. Each buffer is encapsulated in a
...
public abstract class Image implements AutoCloseable {
    ...
    public static abstract class Plane {
        ...
        /**
         * <p>Get a direct {@link ByteBuffer ByteBuffer}
         * containing the frame data.</p>
         *
         * <p>In particular, the buffer returned will always have
         * {@link ByteBuffer#isDirect isDirect} return {@code true}, so
