...
public class MediaRouter {
    ...
    /**
     * Return the number of {@link RouteCategory categories} currently
    ...
    /**
     * Return the {@link RouteCategory category} at the given index.
    ...
    /**
     * Return the number of {@link RouteInfo routes} currently known
     * to this MediaRouter.
     *
    ...
    public static class RouteCategory {
         ...
         * via calls to {@link #getRouteAt(int)} will be {@link RouteGroup}s.</p>
         *
    ...
    /**
     * Stub implementation of {@link Callback}.
