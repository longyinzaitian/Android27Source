...
public class RingtoneManager {
     ...
     * has the {@link Manifest.permission#READ_EXTERNAL_STORAGE} permission.
     *
     ...
     * doesn't have the {@link Manifest.permission#READ_EXTERNAL_STORAGE} permission,
     * returns null.
     *
    ...
    public static Uri getActualDefaultRingtoneUri(Context context, int type) {
        ...
        final String uriString = System.getStringForUser(context.getContentResolver(),
    ...
    public static void setActualDefaultRingtoneUri(Context context, int type, Uri ringtoneUri) {
        ...
        System.putStringForUser(resolver, setting,
     ...
     * and asks the {@link MediaScanner} to scan that file. This call will block until
     ...
     * APIs in {@link ContentResolver} to update the corresponding columns.
     *
    ...
    public static Uri getCacheForType(int type, int userId) {
        if ((type & TYPE_RINGTONE) != 0) {
            ...
            return ContentProvider.maybeAddUserId(System.NOTIFICATION_SOUND_CACHE_URI,
                    userId);
        } else if ((type & TYPE_ALARM) != 0) {
    ...
    public static int getDefaultType(Uri defaultRingtoneUri) {
        ...
        if (defaultRingtoneUri == null) {
            return -1;
        } else if (defaultRingtoneUri.equals(System.DEFAULT_RINGTONE_URI)) {
            return TYPE_RINGTONE;
        } else if (defaultRingtoneUri.equals(System.DEFAULT_NOTIFICATION_URI)) {
            return TYPE_NOTIFICATION;
        } else if (defaultRingtoneUri.equals(System.DEFAULT_ALARM_ALERT_URI)) {
            return TYPE_ALARM;
        } else {
            return -1;
        }
    ...
    /**
     * Creates a {@link MediaScannerConnection} to scan a ringtone file and add its
     * information to the internal database.
     *
     * It uses a {@link LinkedBlockingQueue} so that the caller can block until
     * the scan is completed.
     */
