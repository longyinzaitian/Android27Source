 ...
 * <ul>
 *   <li> {@link Equalizer}</li>
 *   <li> {@link Virtualizer}</li>
 *   <li> {@link BassBoost}</li>
 *   <li> {@link PresetReverb}</li>
 *   <li> {@link EnvironmentalReverb}</li>
 * </ul>
...
public class AudioEffect {
     ...
     * audio session ID. Returns an array of {@link Descriptor}
     * objects.
     * @param audioSession system wide unique audio session identifier.
     * @throws IllegalStateException
     * @hide
