...
public class AudioManager {
     ...
     * {@link Intent#getIntArrayExtra(String)} to retrieve the encoding values.
     */
    ...
    */
     ...
     * {@link Build.VERSION_CODES#JELLY_BEAN_MR1}, this method initiates a virtual
     * voice call to the bluetooth headset.
     * After API version {@link Build.VERSION_CODES#JELLY_BEAN_MR2} only a raw SCO audio
     ...
     * {@link AudioPolicy} to request audio focus, but also to "lock" it
     ...
     *     focus is granted immediately, or the grant request fails because the system is in a
     *     state where focus cannot change (e.g. a phone call).
     * @param ap a registered {@link AudioPolicy} instance when locking
     *     focus, or null.
     ...
     * {@link #registerMediaButtonEventReceiver(ComponentName)}, but allows
     ...
     * @deprecated Use
     *             {@link MediaSessionManager#addOnActiveSessionsChangedListener(MediaSessionManager.OnActiveSessionsChangedListener, ComponentName)}
     ...
     * @deprecated Use
     *             {@link MediaSessionManager#removeOnActiveSessionsChangedListener(MediaSessionManager.OnActiveSessionsChangedListener)}
     *             instead.
     */
    @Deprecated
