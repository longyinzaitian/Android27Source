 ...
 * <p>The {@link Builder} class can be used to create instances of
 * the <code>AudioFormat</code> format class.
 * Refer to
 * {@link Builder} for documentation on the mechanics of the configuration and building
