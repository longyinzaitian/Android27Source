 ...
 * {@link Surface}, and have it be consumed by another component
 * like {@link android.hardware.camera2.CameraDevice CameraDevice}.
 * </p>
 * <p>
 * Several Android API classes can provide input {@link Surface
 ...
 * Image data into a destination {@link Surface Surface}, the
 ...
 * </p>
 * <p>
 * If the consumer component that provided the input {@link Surface Surface}
 * abandons the {@link Surface Surface}, {@link #queueInputImage queueing}
...
public class ImageWriter implements AutoCloseable {
     ...
     *             {@link Surface Surface} has been abandoned by the
     *             consumer component that provided the {@link Surface Surface}.
     * @see #queueInputImage
     * @see Image#close
     */
