...
public final class MediaProjection {
    ...
    /**
     * Creates a {@link VirtualDisplay} to capture the
     ...
     * @param handler The {@link Handler} on which the callback should be
    ...
    public static abstract class Callback {
         ...
         * resources it may be holding (e.g. {@link VirtualDisplay}s).
         * </p>
         */
        public void onStop() { }
    }
