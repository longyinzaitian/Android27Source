...
public class FragmentCompat {
    ...
    public interface OnRequestPermissionsResultCallback {
         ...
         * is invoked for every call on {@link #requestPermissions(Fragment,
         * String[], int)}
         *
         ...
         *
         * @see #requestPermissions(Fragment, String[], int)
         */
     ...
     *     Context, String)
     * @see #shouldShowRequestPermissionRationale(Fragment, String)
     */
