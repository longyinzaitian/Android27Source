...
public final class MediaControllerCompat {
     ...
     * @see Activity#setMediaController(MediaController)
     */
     ...
     * @param description The {@link MediaDescriptionCompat} for creating the
     *            {@link QueueItem} to be inserted.
     * @param index The index at which the created {@link QueueItem}
     *            is to be inserted.
     * @throws UnsupportedOperationException If this session doesn't support this.
     * @see #getFlags()
     * @see MediaSessionCompat#FLAG_HANDLES_QUEUE_COMMANDS
    ...
    /**
     * Removes the first occurrence of the specified {@link QueueItem}
     ...
     * {@link MediaController} object.
     * <p>
     * This method is only supported on API 21+.
     * </p>
     *
     * @return The underlying {@link MediaController}
    ...
    public static abstract class TransportControls {
         ...
         */
        public abstract void sendCustomAction(CustomAction customAction,
                Bundle args);
         ...
         *
         * @see #sendCustomAction(CustomAction action,
         *      Bundle args)
         ...
         *            {@link CustomAction} as specified by
