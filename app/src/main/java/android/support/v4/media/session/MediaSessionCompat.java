...
public class MediaSessionCompat {
     ...
     *            {@link Build.VERSION_CODES#JELLY_BEAN_MR2} and
     *            {@link Build.VERSION_CODES#KITKAT_WATCH} instead of the
     *            component name.
     */
     ...
     * {@link Build.VERSION_CODES#LOLLIPOP} and later. Earlier
     ...
     * this session.
     * <p>
     * On platforms earlier than {@link Build.VERSION_CODES#LOLLIPOP}
     ...
     * {@link Build.VERSION_CODES#LOLLIPOP} this token may only be
     ...
     * {@link MediaMetadataCompat.Builder}. This operation may take time
     * proportional to the size of the bitmap to replace large bitmaps with a scaled down copy.
     *
     * @param metadata The new metadata
     * @see MediaMetadataCompat.Builder#putBitmap
     */
    ...
    /**
     * Gets the underlying framework {@link RemoteControlClient}
     * object.
     * <p>
     * This method is only supported on APIs 14-20. On API 21+
     * {@link #getMediaSession()} should be used instead.
     *
     * @return The underlying {@link RemoteControlClient} object,
     *         or null if none.
     */
    ...
    public static final class Token implements Parcelable {
         ...
         * {@link Build.VERSION_CODES#LOLLIPOP} and later.
         * </p>
         *
    ...
    public static final class QueueItem implements Parcelable {
         ...
         * <p>
         * On builds before {@link Build.VERSION_CODES#LOLLIPOP} null
         * is returned.
         *
