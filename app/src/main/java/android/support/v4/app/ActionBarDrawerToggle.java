 ...
 *
 * <ul>
 * <li>{@link Activity#onConfigurationChanged(Configuration) onConfigurationChanged}</li>
 * <li>{@link Activity#onOptionsItemSelected(MenuItem) onOptionsItemSelected}</li>
 * </ul>
 *
