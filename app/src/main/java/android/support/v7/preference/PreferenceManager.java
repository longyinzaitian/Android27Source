...
public class PreferenceManager {
    ...
    /**
     * Data store to be used by the Preferences or null if {@link SharedPreferences}
     * should be used.
     */
    @Nullable
     ...
     * set, the child preferences won't use {@link SharedPreferences} as long as
     ...
     * the default {@link SharedPreferences} are used instead.
     *
     ...
     * as {@link Context#MODE_PRIVATE} or {@link
    ...
    /**
     * Returns the {@link OnNavigateToScreenListener}, if one has been set.
     */
