...
public abstract class AppCompatDelegate {
    ...
    /**
     * Create a {@link AppCompatDelegate} to use with {@code activity}.
     *
    ...
    /**
     * Create a {@link AppCompatDelegate} to use with {@code dialog}.
     *
     * @param callback An optional callback for AppCompat specific events
     */
     ...
     * {@link Build.VERSION_CODES#ICE_CREAM_SANDWICH} and above.
     *
