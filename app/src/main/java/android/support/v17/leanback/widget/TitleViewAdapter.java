...
/**
 * This class allows a customized widget class to implement {@link Provider}
...
public abstract class TitleViewAdapter {
    ...
    /**
     * Sets the {@link SearchOrbView.Colors} used to draw the
     * search affordance.
     *
    ...
    /**
     * Returns the {@link SearchOrbView.Colors} used to draw the
     * search affordance.
     *
