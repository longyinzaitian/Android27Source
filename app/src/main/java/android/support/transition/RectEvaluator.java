...
class RectEvaluator implements TypeEvaluator<Rect> {
     ...
     * {@link RectEvaluator#RectEvaluator(Rect)} should be used
     * whenever possible.
     */
    RectEvaluator() {
    }
     ...
     * in {@link #evaluate(float, Rect, Rect)} calls.
     * The value returned from
     * {@link #evaluate(float, Rect, Rect)} should
     ...
     *
     * <p>If {@link #RectEvaluator(Rect)} was used to construct
