 ...
 * Config} instance.
 * <p/>
 * EmojiCompat has to be initialized using {@link #init(Config)} function before it can
 ...
 * Config} for more configuration parameters.
 * <p/>
...
public class EmojiCompat {
     ...
     * Config#setReplaceAll(boolean)} configuration parameter. The key is added only if
    ...
    /**
     * Replace strategy that uses the value given in {@link Config}.
     */
     ...
     * {@link #init(Config)} is called to initialize the singleton instance.
     *
     * @return EmojiCompat instance
     *
     * @throws IllegalStateException if called before {@link #init(Config)}
     */
