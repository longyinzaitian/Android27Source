 ...
 * also specify that it handles the {@link Intent} with action {@link
...
public abstract class PrintService extends Service {
     ...
     * another one using the {@link PrintJobInfo.Builder PrintJobInfo.Builder} class.
     * You can specify any standard properties and add advanced, printer specific, ones via
     * {@link PrintJobInfo.Builder#putAdvancedOption(String, String)
     * PrintJobInfo.Builder.putAdvancedOption(String, String)} and
     * {@link PrintJobInfo.Builder#putAdvancedOption(String, int)
     ...
     * get the current {@link PrinterInfo PrinterInfo} using the
     ...
     * {@link PrinterInfo} to your activity allowing you to inspect it.
     *
