...
public class TextKeyListener extends BaseKeyListener implements SpanWatcher {
    ...
    /* package */ static final Object ACTIVE = new Concrete();
    /* package */ static final Object CAPPED = new Concrete();
    /* package */ static final Object INHIBIT_REPLACEMENT = new Concrete();
    /* package */ static final Object LAST_TYPED = new Concrete();
    ...
    private void initPrefs(Context context) {
        ...
        if (mObserver == null) {
            ...
            contentResolver.registerContentObserver(System.CONTENT_URI, true, mObserver);
        }
