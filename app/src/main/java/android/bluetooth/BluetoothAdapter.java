...
public final class BluetoothAdapter {
     ...
     *
     * <p>Requires the {@link Manifest.permission#BLUETOOTH_ADMIN}
     * permission
     *
     * @return true to indicate adapter shutdown has begun, or false on
     *         immediate error
     ...
     *
     * <p>Requires the {@link Manifest.permission#BLUETOOTH_PRIVILEGED}
     * permission
     *
     ...
     * wait for {@link #ACTION_STATE_CHANGED} with {@link #STATE_ON}
     * to get the updated value.
     * <p>Requires {@link Manifest.permission#WRITE_SECURE_SETTINGS}
     ...
     * BluetoothSocket#connect()}. Discovery is not managed by
