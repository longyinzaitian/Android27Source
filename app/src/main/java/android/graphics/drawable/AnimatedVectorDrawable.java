...
/**
 * This class animates properties of a {@link VectorDrawable} with
 * animations defined using {@link ObjectAnimator} or
 * {@link AnimatorSet}.
 * <p>
 ...
 * {@link AnimationCallback#onAnimationEnd(Drawable)} will be
 ...
 * {@link VectorDrawable}. These attributes will be animated by
 * {@link ObjectAnimator}. The ObjectAnimator's target can be the root element,
 ...
 * </p>
 * <p>
 * Here are all the animatable attributes in {@link VectorDrawable}:
...
public class AnimatedVectorDrawable extends Drawable implements Animatable2 {
    ...
    private ArrayList<AnimationCallback> mAnimationCallbacks = null;
