...
public class BitmapFactory {
     ...
     * @throws IllegalArgumentException if {@link Options#inPreferredConfig}
     *         is {@link Bitmap.Config#HARDWARE}
     *         and {@link Options#inMutable} is set, if the specified color space
    ...
    /**
     * Synonym for {@link #decodeResource(Resources, int, Options)}
     * with null Options.
     *
     * @param res The resources object containing the image data
     * @param id The resource id of the image data
