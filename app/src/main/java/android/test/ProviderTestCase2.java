 ...
 * <ul>
 *      <li>
 *          An {@link IsolatedContext} that stubs out Context methods that might
 *          affect the rest of the running system, while allowing tests to do real file and
 *          database work.
 *      </li>
 *      <li>
 *          A {@link MockContentResolver} that provides the functionality of a
...
public abstract class ProviderTestCase2<T extends ContentProvider> extends AndroidTestCase {
     ...
     * <p>
     * Creates a new
     * {@link MockContentResolver}, a new IsolatedContext
     ...
     * <p>
     * Calls {@link ContentProvider#shutdown()} on the
     * {@link ContentProvider} represented by mProvider.
     */
    @Override
