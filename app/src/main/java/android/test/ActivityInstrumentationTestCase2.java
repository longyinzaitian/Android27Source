 ...
 * <ul>
 * <li>You can run any test method on the UI thread (see {@link UiThreadTest}).</li>
 * <li>You can inject custom Intents into your Activity (see
 * {@link #setActivityIntent(Intent)}).</li>
 * </ul>
 *
 * <p>This class replaces {@link ActivityInstrumentationTestCase}, which is deprecated.
 * New tests should be written using this base class.
 *
 * <p>If you prefer an isolated unit test, see {@link ActivityUnitTestCase}.
 *
 * @deprecated Use
...
public abstract class ActivityInstrumentationTestCase2<T extends Activity>
     ...
     * If your test method is annotated with {@link UiThreadTest}, then your Activity
     ...
     *
     * <p><b>NOTE:</b> Activities under test may not be started from within the UI thread.
     * If your test method is annotated with {@link UiThreadTest}, then you must call
     ...
     * {@link UiThreadTest}, force the Activity to be created before switching to
     * the UI thread.
     */
    @Override
