 ...
 *
 * <p>If you prefer a functional test, see {@link ActivityInstrumentationTestCase}.
 *
 ...
 * exceptions:
 * <ul>
 * <li>{@link Activity#createPendingResult(int, Intent, int)}</li>
 * <li>{@link Activity#startActivityIfNeeded(Intent, int)}</li>
 * <li>{@link Activity#startActivityFromChild(Activity, Intent, int)}</li>
 * <li>{@link Activity#startNextMatchingActivity(Intent)}</li>
 * <li>{@link Activity#getCallingActivity()}</li>
 * <li>{@link Activity#getCallingPackage()}</li>
 * <li>{@link Activity#createPendingResult(int, Intent, int)}</li>
 * <li>{@link Activity#getTaskId()}</li>
 * <li>{@link Activity#isTaskRoot()}</li>
 * <li>{@link Activity#moveTaskToBack(boolean)}</li>
 * </ul>
 *
 ...
 * <ul>
 * <li>{@link Activity#startActivity(Intent)}</li>
 ...
 * <ul>
 * <li>{@link Activity#finish()}</li>
 * <li>{@link Activity#finishFromChild(Activity child)}</li>
 * <li>{@link Activity#finishActivity(int requestCode)}</li>
 * </ul>
 *
 * @deprecated Write
...
public abstract class ActivityUnitTestCase<T extends Activity>
     ...
     * {@link Context#startActivity Context.startActivity()}, providing the
     ...
     * test methods.</i>
     *
     * @param intent The Intent as if supplied to {@link Context#startActivity}.
     ...
     * Activity if it calls {@link Activity#getLastNonConfigurationInstance()}.
     * Typically null.
     ...
     * {@link Activity#setRequestedOrientation}.
     */
     ...
     * {@link Activity#startActivity(Intent)} or
     ...
     * {@link Activity#finishFromChild(Activity)}, or
     * {@link Activity#finishActivity(int)}.
     ...
     * <ul>
     * <li>{@link Activity#getRequestedOrientation()}</li>
     * <li>{@link Activity#setRequestedOrientation(int)}</li>
     * <li>{@link Activity#finish()}</li>
     * <li>{@link Activity#finishActivity(int requestCode)}</li>
     * <li>{@link Activity#finishFromChild(Activity child)}</li>
     * </ul>
