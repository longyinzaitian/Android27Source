 ...
 *      </li>
 *      <li>
 *          The test case waits to call {@link Service#onCreate()} until one of your
 ...
 *          {@link Service#onCreate() Service.onCreate()} and then calls either
 *          {@link Service#startService(Intent) Service.startService(Intent)} or
 *          {@link Service#bindService(Intent, ServiceConnection, int)
 ...
 *      A service has two inherent dependencies, its {@link Context Context} and its
 *      associated {@link Application Application}. The ServiceTestCase framework
 ...
 *      {@link MockApplication MockApplication} object. You can inject
 ...
 *      {@link RenamingDelegatingContext RenamingDelegatingContext},
 *      {@link android.content.ContextWrapper ContextWrapper}, and
 *      {@link IsolatedContext}.
 *
 * @deprecated Use
...
public abstract class ServiceTestCase<T extends Service> extends AndroidTestCase {
     ...
     * {@link Context#startService(Intent) Context.startService(Intent)} with
     * an {@link Intent} that identifies a service.
     ...
     * {@link Context#startService(Intent) Context.startService(Intent)}.
     */
     ...
     *      {@link Intent} that identifies a service.
     * </p>
     * <p>
     ...
     *      subclass of {@link IBinder}, or null if the method fails. An IBinder
     *      object refers to a communication channel between the application and
     *      the service. The flag is assumed to be {@link Context#BIND_AUTO_CREATE}.
     * </p>
     * <p>
     ...
     * a new {@link MockApplication MockApplication} object is used.
     *
