 ...
 * method calls (see {@link Application} for more details).
 ...
 * Every Application has one inherent dependency, the {@link Context Context} in
 * which it runs.
 ...
 * {@link RenamingDelegatingContext RenamingDelegatingContext}, and
