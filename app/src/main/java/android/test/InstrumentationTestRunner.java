...
/**
 * An {@link Instrumentation} that runs various types of {@link TestCase}s against
 ...
 * <h3>Typical Usage</h3>
 * <ol>
 * <li>Write {@link TestCase}s that perform unit, functional, or performance tests
 * against the classes in your package.  Typically these are subclassed from:
 *   <ul><li>{@link ActivityInstrumentationTestCase2}</li>
 *   <li>{@link ActivityUnitTestCase}</li>
 *   <li>{@link AndroidTestCase}</li>
 *   <li>{@link ApplicationTestCase}</li>
 *   <li>{@link InstrumentationTestCase}</li>
 *   <li>{@link ProviderTestCase}</li>
 *   <li>{@link ServiceTestCase}</li>
 *   <li>{@link SingleLaunchActivityTestCase}</li></ul>
 ...
 * from {@link InstrumentationTestCase} (and are not performance tests).
 * <li>Run the instrumentation using "adb shell am instrument -w",
 * with the argument '-e class' set to run an individual {@link TestCase}.
 * </ol>
 * <p/>
...
public class InstrumentationTestRunner extends Instrumentation implements TestSuiteProvider {
    ...
    /**
     * This value, if stored with key {@link Instrumentation#REPORT_KEY_IDENTIFIER},
