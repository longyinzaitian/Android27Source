 ...
 * <p>
 * Once {@link Builder#build() built} the objects are immutable.
 * </p>
 */
public final class PrinterInfo implements Parcelable {
    ...
    public static final class Builder {
         ...
         * @return This builder.
         * @see Builder#setHasCustomPrinterIcon
         */
         ...
         * {@link Builder#setIconResourceId} and a custom icon are set the resource icon
         * is shown while the custom icon loads but then the custom icon is used. If
         * {@link Builder#setIconResourceId} is not set the printer's service's icon is
         * shown while loading.
         * <p>
