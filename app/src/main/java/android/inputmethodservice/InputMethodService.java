 ...
 * work: the {@link InputMethodService} provides
 ...
 * {@link InputConnection} interface to the
 ...
 * through the {@link EditorInfo} class, which is
 * retrieved with {@link #getCurrentInputEditorInfo()} method.  The most
 * important part of this is {@link EditorInfo#inputType
 * EditorInfo.inputType}; in particular, if this is
 * {@link EditorInfo#TYPE_NULL EditorInfo.TYPE_NULL},
...
public class InputMethodService extends AbstractInputMethodService {
    ...
    /**
     * Concrete implementation of
     * {@link AbstractInputMethodSessionImpl} that provides
     ...
     * this is mainly for use with {@link InputType#TYPE_NULL} type
     * text fields, or for non-rich input methods. A reasonably capable software
     * input method should use the
     * {@link InputConnection#commitText} family of methods
     ...
     * by calling this in
     * {@link InputMethodService#onStartInputView(EditorInfo, boolean)}.
