...
public class TelephonyManager {
     ...
     *
     * <p class="note">
     * This was a {@link Context#sendStickyBroadcast sticky}
     ...
     * <p>The intent contains a URI (available from {@link Intent#getData})
     ...
     * Intent#EXTRA_TEXT}) and a message subject
     * (in {@link Intent#EXTRA_SUBJECT}).</p>
     *
     ...
     * <p class="note">
     * Retrieve with
     * {@link Intent#getIntExtra(String name, int defaultValue)}.
     *
     * @hide
     */
     ...
     * <p class="note">
     * Retrieve with
     * {@link Intent#getStringExtra(String name)}.
     *
     * @hide
     */
     ...
     * <p class="note">
     * Retrieve with
     * {@link Intent#getParcelableExtra(String name)}.
     *
     * @hide
     */
     ...
     * The {@link #EXTRA_CALL_VOICEMAIL_INTENT} extra is a {@link PendingIntent} that
     ...
     * {@link PendingIntent} that will launch the voicemail settings. This extra is only
     ...
     * <p>
     * Returned via {@link UssdResponseCallback#onReceiveUssdResponseFailed(
    ...
    */
     ...
     * not trigger a call to {@link PhoneStateListener#onCellInfoChanged
     * onCellInfoChanged()}, or change the rate at which
     * {@link PhoneStateListener#onCellInfoChanged
     * onCellInfoChanged()} is called.
     *
     *<p>
     * The list can include one or more {@link CellInfoGsm CellInfoGsm},
     * {@link CellInfoCdma CellInfoCdma},
     * {@link CellInfoLte CellInfoLte}, and
     * {@link CellInfoWcdma CellInfoWcdma} objects, in any combination.
     ...
     * {@link CellInfo#isRegistered CellInfo.isRegistered()}
     ...
     * @hide
     */
    public static int getIntAtIndex(ContentResolver cr,
     ...
     * @hide
     */
    public static boolean putIntAtIndex(ContentResolver cr,
