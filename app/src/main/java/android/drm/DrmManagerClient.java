...
public class DrmManagerClient implements AutoCloseable {
    ...
    /**
     * Registers an {@link OnInfoListener} callback, which is invoked when the
    ...
    /**
     * Registers an {@link OnEventListener} callback, which is invoked when the
    ...
    /**
     * Registers an {@link OnErrorListener} callback, which is invoked when
     ...
     *
     * @return A {@link ContentValues} instance that contains
