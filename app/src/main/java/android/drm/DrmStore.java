...
public class DrmStore {
     ...
     * {@link DrmManagerClient#getConstraints DrmManagerClient.getConstraints()}
     * can be called by an application to find out the contraints on the
     * {@link Action actions} that can be performed
    ...
    public interface ConstraintsColumns {
         ...
         * an {@link Action action} can be performed on
         ...
         * an {@link Action action} can not be performed on
         * the rights-protected content.
         * <p>
         * Type: TEXT
         */
