...
/**
 * The current condition of an {@link AutomaticZenRule}, provided by the
...
public final class Condition implements Parcelable {
     ...
     * See {@link AutomaticZenRule#getConditionId()}.
     */
    public final Uri id;
    ...
    /**
     * An object representing the current state of a {@link AutomaticZenRule}.
     * @param id the {@link AutomaticZenRule#getConditionId()} of the zen rule
