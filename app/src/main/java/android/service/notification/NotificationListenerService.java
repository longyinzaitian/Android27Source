...
public abstract class NotificationListenerService extends Service {
     ...
     * {@link Notification#contentIntent} by tapping/clicking/etc., you should call
     * this method at that time <i>if</i> the Notification in question has the
     * {@link Notification#FLAG_AUTO_CANCEL} flag set.
     *
     * <p>The service should wait for the {@link #onListenerConnected()} event
     ...
     * instead. Beginning with {@link Build.VERSION_CODES#LOLLIPOP} this method will no longer
     * cancel the notification. It will continue to cancel the notification for applications
     * whose {@code targetSdkVersion} is earlier than {@link Build.VERSION_CODES#LOLLIPOP}.
     */
    @Deprecated
    ...
    public static class Ranking {
         ...
         * {@link Ranking#VISIBILITY_NO_OVERRIDE} if
