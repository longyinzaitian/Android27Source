 ...
 * should extend {@link Session}.
 * </p>
 *
 * <h3>Returning spell check results</h3>
 *
 * <p>{@link Session#onGetSuggestions(TextInfo, int)}
 * should return spell check results.
 * It receives {@link TextInfo} and returns
 * {@link SuggestionsInfo} for the input.
 * You may want to override
 * {@link Session#onGetSuggestionsMultiple(TextInfo[], int, boolean)} for
 * better performance and quality.
 * </p>
 *
 * <p>Please note that {@link Session#getLocale()} does not return a valid
 * locale before {@link Session#onCreate()} </p>
 *
 */
public abstract class SpellCheckerService extends Service {
     ...
     * APIs used in
     * {@link Session#onGetSuggestionsMultiple(TextInfo[], int, boolean)}
     */
