 ...
 * {@link AccessibilityService} a window's content is
 ...
 * </p>
 * <p>
 * Please refer to {@link AccessibilityService} for
...
public class AccessibilityNodeInfo implements Parcelable {
     ...
     *
     * @see #setTraversalBefore(View)
     * @see #setTraversalBefore(View, int)
     */
     ...
     * @return The succeeding node if such or <code>null</code>.
     *
     * @see #setTraversalAfter(View)
     * @see #setTraversalAfter(View, int)
     */
     ...
     *   from an {@link AccessibilityService}.
     * </p>
     *
     ...
     * <p>
     * <strong>Note:</strong> Cannot be called from an
     * {@link AccessibilityService}. This class is made immutable
     ...
     * <p>
     * <strong>Note:</strong> Cannot be called from an
     * {@link AccessibilityService}. This class is
    ...
    public static final class RangeInfo {
        ...
        private static final SynchronizedPool<RangeInfo> sPool =
                new SynchronizedPool<RangeInfo>(MAX_POOL_SIZE);
    ...
    public static final Creator<AccessibilityNodeInfo> CREATOR =
            new Creator<AccessibilityNodeInfo>() {
        @Override
