 ...
 * {@link Context#checkPermission(String, int, int)} and
...
public interface WindowManagerPolicy {
     ...
     *        types {@link WindowManager.LayoutParams#isSystemAlertWindowType(int)}
     *        can be assigned layers greater than the layer for
     *        {@link WindowManager.LayoutParams#TYPE_APPLICATION_OVERLAY} Else, their
