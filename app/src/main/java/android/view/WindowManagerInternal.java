...
public abstract class WindowManagerInternal {
    ...
    */
     ...
     */
    public abstract void addWindowToken(IBinder token, int type, int displayId);
     ...
     */
    public abstract void removeWindowToken(IBinder token, boolean removeWindows,
            int displayId);
     ...
     *                 identified by checking {@link WindowManager.LayoutParams#token}.
