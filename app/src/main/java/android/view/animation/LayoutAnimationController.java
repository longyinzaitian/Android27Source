 ...
 * is used by {@link ViewGroup} to compute the delay by which each
 ...
 * {@link #getDelayForView(View)} to implement a different way
 * of computing the delay. For instance, a
 * {@link GridLayoutAnimationController} will compute the
 ...
 * in an instance of
 * {@link AnimationParameters},
 * itself stored in the {@link ViewGroup.LayoutParams} of the view.
 *
...
public class LayoutAnimationController {
     ...
     *         {@link #getDelayForView(View)}
     *
     * @see #getDelay()
     * @see #setDelay(float)
     * @see #getDelayForView(View)
     */
     ...
     * {@link AnimationParameters}
     * found in the view's {@link ViewGroup.LayoutParams}.
     *
     * @param view the view for which to obtain the animation's delay
     * @return a delay in milliseconds
     *
     * @see #getAnimationForView(View)
     * @see #getDelay()
     * @see #getTransformedIndex(AnimationParameters)
     ...
     * {@link #getDelayForView(View)} prior to any computation.
     *
