 ...
 * </ul>
 * Starting with {@link Build.VERSION_CODES#ICE_CREAM_SANDWICH},
...
public class AnimationSet extends Animation {
     ...
     *
     * @see Animation#setStartTime(long)
     */
    @Override
     ...
     *
     * @see Animation#computeDurationHint
     */
     ...
     *
     * @see Animation#getTransformation
     */
    @Override
    ...
    /**
     * @see Animation#scaleCurrentDuration(float)
     */
    @Override
    ...
    /**
     * @see Animation#initialize(int, int, int, int)
     */
    @Override
