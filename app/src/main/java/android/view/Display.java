...
public final class Display {
     ...
     * Applications should use {@link WindowManager#getDefaultDisplay()}
     * or {@link DisplayManager#getDisplay}
     ...
     * {@link Configuration#smallestScreenWidthDp
     ...
     * @return One of the constants defined in {@link PixelFormat}.
     *
    ...
    public Mode[] getSupportedModes() {
        synchronized (this) {
            updateDisplayInfoLocked();
            final Mode[] modes = mDisplayInfo.supportedModes;
    ...
    public static final class Mode implements Parcelable {
         ...
         * rendering content through a {@link SurfaceView} using full size buffers.
         */
