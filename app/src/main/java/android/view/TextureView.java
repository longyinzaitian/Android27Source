...
public class TextureView extends View {
    ...
    /**
     * <p>Returns a {@link Bitmap} representation of the content
     ...
     * ({@link #onDraw(Canvas)} for instance).</p>
     *
     ...
     * to implement
     * {@link SurfaceTextureListener#onSurfaceTextureAvailable(SurfaceTexture, int, int)}
     ...
     *
     * @see #lockCanvas(Rect)
     * @see #unlockCanvasAndPost(Canvas)
     */
     ...
     * texture view.
     *
     * @see #setSurfaceTextureListener(SurfaceTextureListener)
