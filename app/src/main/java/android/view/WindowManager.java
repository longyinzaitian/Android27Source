...
public interface WindowManager extends ViewManager {
     ...
     * be found. See {@link Presentation} for more information on secondary displays.
     */
     ...
     */
    @SystemApi
    @RequiresPermission(permission.RESTRICTED_VR_ACCESS)
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
         ...
         * <p>
         * Requires {@link permission#SYSTEM_ALERT_WINDOW} permission.
         * <p>
         ...
         * or implementing you own {@link View#fitSystemWindows(Rect)
         ...
         * {@link Gravity#apply(int, int, int, Rect, int, int,
         * Rect) Gravity.apply} and
         * {@link Gravity#applyDisplay(int, Rect, Rect)
         ...
         * {@link PixelFormat}. The choice of format
         ...
         * for {@link ActivityInfo#screenOrientation}.
         ...
         * override the window's pixel {@link LayoutParams#format format}.</p>
         *
