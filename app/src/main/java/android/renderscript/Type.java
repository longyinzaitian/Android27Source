...
/**
 * <p>A Type describes the {@link Element} and dimensions used for an {@link
 * Allocation} or a parallel operation. Types are created through {@link
 * Builder}.</p>
 *
 * <p>A Type always includes an {@link Element} and an X
 ...
 * {@link Allocation} in a YUV format. The YUV formats
