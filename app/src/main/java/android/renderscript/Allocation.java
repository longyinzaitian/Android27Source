 ...
 * Sampler}. A developer must synchronize across these
 * different usages using {@link Allocation#syncAll} in
...
public class Allocation extends BaseObj {
    ...
    /**
     * The Allocation will be used as a {@link Surface}
     ...
     * Surface} will be forced to those of the
     * Allocation.
     *
     */
     ...
     * (usually a {@link Bitmap}); copying to or from the
   ...
   /**
     * Get the {@link Element} of the {@link
     ...
     * the same {@link Element.DataType}, with the fourth vector
    ...
    /**
     * Get the {@link Type} of the Allocation.
     *
     * @return Type
     *
     */
     ...
     * Element} does not match the array's
     * primitive type.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     ...
     * Copy into this Allocation from an array.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is not a 32 bit integer nor a vector of 32 bit
     * integers {@link Element.DataType}.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     * #getBytesSize getBytesSize()}.
     ...
     * Copy into this Allocation from an array.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is not a 16 bit integer nor a vector of 16 bit
     * integers {@link Element.DataType}.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     ...
     * Copy into this Allocation from an array.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is not an 8 bit integer nor a vector of 8 bit
     * integers {@link Element.DataType}.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     ...
     * Copy into this Allocation from an array.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is neither a 32 bit float nor a vector of
     * 32 bit floats {@link Element.DataType}.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     * #getBytesSize getBytesSize()}.
    ...
    /**
     * Copy into an Allocation from a {@link Bitmap}.  The
     * height, width, and format of the bitmap must match the existing
     * allocation.
     *
     * <p>If the {@link Bitmap} is the same as the {@link
     * Bitmap} used to create the Allocation with {@link
     ...
     * Bitmap}, potentially avoiding the actual copy.</p>
     *
     ...
     * Copy an array into a 1D region of this Allocation.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is not an 32 bit integer nor a vector of 32 bit
     * integers {@link Element.DataType}.
     *
     * <p> The size of the region is: count * {@link #getElement}.{@link
     * Element#getBytesSize}.
     ...
     * Copy an array into a 1D region of this Allocation.  This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is not an 16 bit integer nor a vector of 16 bit
     * integers {@link Element.DataType}.
     *
     * <p> The size of the region is: count * {@link #getElement}.{@link
     * Element#getBytesSize}.
     ...
     * and will generate exceptions if the Allocation's {@link
     * Element} does not match the input data type.
     *
    ...
    /**
     * Copy a {@link Bitmap} into an Allocation.  The height
    ...
    /**
     * Copy from the Allocation into a {@link Bitmap}.  The
     ...
     * and will generate exceptions if the Allocation's {@link
     * Element} is neither an 8 bit integer nor a vector of 8 bit
     * integers {@link Element.DataType}.
     *
     * <p> If the Allocation does not have Vec3 Elements, then the size of the
     * array in bytes must be at least the size of the Allocation {@link
     ...
     * and will generate exceptions if the Allocation's {@link
     * Element} is neither a 32 bit integer nor a vector of 32 bit
     * integers {@link Element.DataType}.
     *
     * <p> The size of the region is: count * {@link #getElement}.{@link
     * Element#getBytesSize}.
     ...
     * Copy a 1D region of this Allocation into an array. This variant is type checked
     * and will generate exceptions if the Allocation's {@link
     * Element} is neither a 16 bit integer nor a vector of 16 bit
     * integers {@link Element.DataType}.
     *
     * <p> The size of the region is: count * {@link #getElement}.{@link
     * Element#getBytesSize}.
     ...
     * {@link Element} does not match the component type
     * of the array passed in.
     *
     * <p> The size of the region is: w * h * {@link #getElement}.{@link
     * Element#getBytesSize}.
     ...
     * {@link Element} is neither an 8 bit integer nor a vector
     * of 8 bit integers {@link Element.DataType}.
     *
     * <p> The size of the region is: w * h * {@link #getElement}.{@link
     * Element#getBytesSize}.
     *
     ...
     * Copy from a rectangular region in this Allocation into an array. This
     * variant is type checked and will generate exceptions if the Allocation's
     * {@link Element} is neither a 16 bit integer nor a vector
     * of 16 bit integers {@link Element.DataType}.
     *
     * <p> The size of the region is: w * h * {@link #getElement}.{@link
     * Element#getBytesSize}.
     *
     ...
     * Copy from a rectangular region in this Allocation into an array. This
     * variant is type checked and will generate exceptions if the Allocation's
     * {@link Element} is neither a 32 bit integer nor a vector
     * of 32 bit integers {@link Element.DataType}.
     *
     * <p> The size of the region is: w * h * {@link #getElement}.{@link
     * Element#getBytesSize}.
     *
     ...
     * Copy from a rectangular region in this Allocation into an array. This
     * variant is type checked and will generate exceptions if the Allocation's
     * {@link Element} is neither a 32 bit float nor a vector
     * of 32 bit floats {@link Element.DataType}.
     *
     * <p> The size of the region is: w * h * {@link #getElement}.{@link
     * Element#getBytesSize}.
     *
    ...
    /**
     * Creates an Allocation from a {@link Bitmap}.
     *
     * @param rs Context to which the allocation will belong.
    ...
    /**
     * Creates a new Allocation with the given {@link
     * Allocation}. The same data layout of
    ...
    /**
     * Associate a {@link Surface} with this Allocation. This
    ...
    /**
     * Creates a cubemap Allocation from a {@link Bitmap}
     ...
     * from a {@link Bitmap} containing the horizontal list of
    ...
    /**
     * Creates a cubemap Allocation from 6 {@link Bitmap}
     ...
     * from 6 {@link Bitmap} objects containing the cube
     ...
     * {@link Bitmap} referenced by resource ID.
     *
     * <p>With target API version 18 or greater, this allocation will be created
