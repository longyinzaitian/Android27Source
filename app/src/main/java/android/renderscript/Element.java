 ...
 * Allocation}.  An Element is roughly equivalent to a C
 ...
 * DataType} and a {@link
 * DataKind}. The DataType encodes C type
 * information of an Element, while the DataKind encodes how that Element should
 * be interpreted by a {@link Sampler}. Note that {@link
 * Allocation} objects with DataKind {@link
 * DataKind#USER} cannot be used as input for a
 * {@link Sampler}. In general, {@link
 * Allocation} objects that are intended for use with a
 * {@link Sampler} should use bitmap-derived Elements such
 * as {@link Element#RGBA_8888} or {@link
    ...
    */
    ...
    public static class Builder {
        ...
        public Element create() {
            ...
            System.arraycopy(mElements, 0, ein, 0, mCount);
            System.arraycopy(mElementNames, 0, sin, 0, mCount);
            System.arraycopy(mArraySizes, 0, asin, 0, mCount);
