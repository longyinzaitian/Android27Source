...
public class AccountManager {
     ...
     * <ul>
     * <li>Target API level below {@link Build.VERSION_CODES#O} and have
     ...
     * {@link Build.VERSION_CODES#LOLLIPOP_MR1} and before, AUTHENTICATE_ACCOUNTS
     ...
     * Beginning API level {@link Build.VERSION_CODES#O} it also return accounts
     ...
     *
     * <p>
     * Caller targeting API level {@link Build.VERSION_CODES#O} and above, will get list
     ...
     *
     * <p>
     * Caller targeting API level below {@link Build.VERSION_CODES#O} that have not been
     ...
     * <p>
     * <b>NOTE:</b> If targeting your app to work on API level
     * {@link Build.VERSION_CODES#LOLLIPOP_MR1} and before,
     ...
     * function in API level {@link Build.VERSION_CODES#LOLLIPOP_MR1}.
     *
     * @param type The type of accounts to return, null to retrieve all accounts
     * @return An array of {@link Account}, one per matching account. Empty (never null) if no
     ...
     *
     * <p>
     * If caller target API level is below {@link Build.VERSION_CODES#O}, it is
     ...
     * authenticator-dependent.  The caller should verify the validity of the
     * account before requesting an auth token.
     * @deprecated use {@link #getAuthToken(Account, String, Bundle,
     * boolean, AccountManagerCallback, Handler)} instead
     */
    @Deprecated
    public AccountManagerFuture<Bundle> getAuthToken(
