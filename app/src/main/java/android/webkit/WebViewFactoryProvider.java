...
public interface WebViewFactoryProvider {
    ...
    interface Statics {
         ...
         * {@link WebView#findAddress(String)}
         */
        ...
        /**
         * Implements the API method:
         * {@link WebView#setWebContentsDebuggingEnabled(boolean) }
         */
        void setWebContentsDebuggingEnabled(boolean enable);

        /**
         * Implements the API method:
         * {@link WebView#clearClientCertPreferences(Runnable) }
         */
        void clearClientCertPreferences(Runnable onCleared);

        /**
         * Implements the API method:
         * {@link WebView#setSlowWholeDocumentDrawEnabled(boolean) }
         */
        ...
        /**
         * Implement the API method
         * {@link WebView#startSafeBrowsing(Context , ValueCallback<Boolean>)}
         */
        void initSafeBrowsing(Context context, ValueCallback<Boolean> callback);

        /**
        * Implement the API method
        * {@link WebView#setSafeBrowsingWhitelist(List<String>,
        ...
        */
        ...
        /**
         * Implement the API method
         * {@link WebView#getSafeBrowsingPrivacyPolicyUrl()}
         */
        @NonNull
