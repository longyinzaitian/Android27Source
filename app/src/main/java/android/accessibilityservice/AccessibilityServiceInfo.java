 ...
 * {@link AccessibilityService} for {@link AccessibilityEvent}s
...
public class AccessibilityServiceInfo implements Parcelable {
     ...
     * @see AccessibilityEvent#TYPE_TOUCH_INTERACTION_START
     * @see AccessibilityEvent#TYPE_TOUCH_INTERACTION_END
     * @see AccessibilityEvent#TYPE_ANNOUNCEMENT
     * @see AccessibilityEvent#TYPE_GESTURE_DETECTION_START
     * @see AccessibilityEvent#TYPE_GESTURE_DETECTION_END
     * @see AccessibilityEvent#TYPE_VIEW_ACCESSIBILITY_FOCUSED
     * @see AccessibilityEvent#TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED
     * @see AccessibilityEvent#TYPE_VIEW_TEXT_TRAVERSED_AT_MOVEMENT_GRANULARITY
    ...
    public static final Creator<AccessibilityServiceInfo> CREATOR =
            new Creator<AccessibilityServiceInfo>() {
