 ...
 * app receives the {@link Sms.Intents#SMS_DELIVER_ACTION} broadcast
 * when the user receives an SMS or the {@link
 * Sms.Intents#WAP_PUSH_DELIVER_ACTION} broadcast when the user
 * receives an MMS.</p>
 *
 ...
 * {@link Intent#ACTION_SENDTO} (<code>"android.intent.action.SENDTO"
...
public final class Telephony {
    ...
    public static final class Carriers implements BaseColumns {
         ...
         * To check what values are allowed, refer to {@link ServiceState}.
         ...
         * To check what values can be contained, refer to {@link ServiceState}.
