...
public abstract class SearchIndexablesProvider extends ContentProvider {
    ...
    /**
     * Returns all {@link SearchIndexablesContract.XmlResource}.
     *
     * Those are Xml resource IDs to some {@link android.preference.PreferenceScreen}.
     *
     * @param projection list of {@link SearchIndexablesContract.XmlResource}
    ...
    /**
     * Returns all {@link SearchIndexablesContract.RawData}.
     *
     * Those are the raw indexable data.
     *
     * @param projection list of {@link SearchIndexablesContract.RawData} columns
    ...
    /**
     * Returns all {@link SearchIndexablesContract.NonIndexableKey}.
     *
     * Those are the non indexable data keys.
     *
     * @param projection list of {@link SearchIndexablesContract.NonIndexableKey}
     *                   columns to put into the cursor. If {@code null} all supported columns
     *                   should be included.
     */
