...
public class Contacts {
    ...
    /**
     * @deprecated see {@link ContactsContract}
     */
    @Deprecated
...
//                : "_sync_account=? AND _sync_account_type=? AND key=?";
    ...
    public static final class People implements BaseColumns, PeopleColumns,
        ...
        public static void setPhotoData(ContentResolver cr, Uri person, byte[] data) {
            Uri photoUri = Uri.withAppendedPath(person, Photos.CONTENT_DIRECTORY);
            ContentValues values = new ContentValues();
    ...
    public interface PresenceColumns {
         ...
         * {@link ContactMethods#encodePredefinedImProtocol} or
         * {@link ContactMethods#encodeCustomImProtocol}.
         * <P>Type: STRING</P>
         * @deprecated see {@link ContactsContract}
         */
        @Deprecated
    ...
    public static final class Intents {
        ...
        public static final class Insert {
             ...
             * <P>Type: Either an integer value from {@link PhonesColumns PhonesColumns},
             ...
             * <P>Type: Either an integer value from {@link ContactMethodsColumns ContactMethodsColumns}
             *  or a string specifying a custom label.</P>
             * @deprecated see {@link ContactsContract}
             */
            @Deprecated
             ...
             * <P>Type: the result of {@link ContactMethods#encodePredefinedImProtocol}
             * or {@link ContactMethods#encodeCustomImProtocol}.</P>
             * @deprecated see {@link ContactsContract}
             */
            @Deprecated
