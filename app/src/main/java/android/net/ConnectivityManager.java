...
public class ConnectivityManager {
     ...
     *             {@link #getNetworkInfo(Network)} instead.
     */
    @Deprecated
    @RequiresPermission(android.Manifest.permission.ACCESS_NETWORK_STATE)
     ...
     *             {@link #getNetworkInfo(Network)}, and
     *             {@link #getLinkProperties(Network)} instead.
     */
    @Deprecated
    @RequiresPermission(android.Manifest.permission.ACCESS_NETWORK_STATE)
     ...
     * {@link Settings.System#canWrite}.</p>
     *
     ...
     * settings as determined by {@link Settings.System#canWrite}.</p>
     *
     ...
     * {@link #releaseNetworkRequest(PendingIntent)}.
    ...
    /**
     * Removes a request made via {@link #requestNetwork(NetworkRequest, PendingIntent)}
     * <p>
     * This method has the same behavior as
     * {@link #unregisterNetworkCallback(PendingIntent)} with respect to
     * releasing network resources and disconnecting.
     *
     * @param operation A PendingIntent equal (as defined by {@link Intent#filterEquals}) to the
     *                  PendingIntent passed to
     *                  {@link #requestNetwork(NetworkRequest, PendingIntent)} with the
     ...
     * <p>
     * The request may be released normally by calling
     * {@link #unregisterNetworkCallback(PendingIntent)}.
     * @param request {@link NetworkRequest} describing this request.
     * @param operation Action to perform when the network is available (corresponds
     *                  to the {@link NetworkCallback#onAvailable} call.  Typically
     *                  comes from {@link PendingIntent#getBroadcast}. Cannot be null.
     ...
     * {@link #registerNetworkCallback(NetworkRequest, PendingIntent)}.
     *
     * @param operation A PendingIntent equal (as defined by {@link Intent#filterEquals}) to the
     *                  PendingIntent passed to
     *                  {@link #registerNetworkCallback(NetworkRequest, PendingIntent)}.
