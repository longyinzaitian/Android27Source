 ...
 * SIP. You should always call {@link SipManager#isVoipSupported
 * isVoipSupported()} to verify that the device supports VOIP calling and {@link
 * SipManager#isApiSupported isApiSupported()} to verify that the device supports
...
public class SipManager {
     ...
     * notify the caller with the {@link PendingIntent} when an incoming call is
     * received.
     *
