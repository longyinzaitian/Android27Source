...
public class LowpanManager {
     ...
     * Context#getSystemService Context.getSystemService()} to retrieve the standard
     * {@link Context#LOWPAN_SERVICE Context.LOWPAN_SERVICE}.
     *
    ...
    /**
     * Unregisters a previously registered {@link Callback} object.
     *
     * @hide
     */
