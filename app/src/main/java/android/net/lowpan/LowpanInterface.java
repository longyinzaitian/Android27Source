...
public class LowpanInterface {
     ...
     *
     * @see #setEnabled
     * @see LowpanException#LOWPAN_DISABLED
     */
    ...
    /**
     * Registers a subclass of {@link Callback} to receive events.
     *
     * @param cb Subclass of {@link Callback} which will receive events.
     ...
     *
     * @param cb Subclass of {@link Callback} which was previously registered to
     *     receive events.
     * @see #registerCallback(Callback, Handler)
     * @see #registerCallback(Callback)
     */
    ...
    /**
     * Creates a new {@link LowpanScanner} object for this interface.
     *
