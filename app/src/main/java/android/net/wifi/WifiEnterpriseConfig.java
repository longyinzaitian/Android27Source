...
public class WifiEnterpriseConfig implements Parcelable {
    ...
    public boolean saveToSupplicant(SupplicantSaver saver) {
        ...
        boolean shouldNotWriteAnonIdentity = mEapMethod == Eap.SIM
                || mEapMethod == Eap.AKA
                || mEapMethod == Eap.AKA_PRIME;
     ...
     * {@link #setClientKeyEntry(PrivateKey, X509Certificate)}
     ...
     * PrivateKey, X509Certificate[])} was last called with a
