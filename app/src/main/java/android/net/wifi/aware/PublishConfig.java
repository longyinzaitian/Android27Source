 ...
 * {@link Builder}. A publish session is created using
...
public final class PublishConfig implements Parcelable {
     ...
     * Configuration is done using {@link Builder#setPublishType(int)}.
     */
     ...
     * {@link Builder#setPublishType(int)}.
     */
    ...
    public static final class Builder {
         ...
         * {@link Builder#setPublishType(int)}) publish session
