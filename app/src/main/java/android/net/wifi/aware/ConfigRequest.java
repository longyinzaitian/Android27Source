 ...
 * {@link Builder}. Configuration is requested using
...
public final class ConfigRequest implements Parcelable {
    ...
    public static final class Builder {
         ...
         * the {@link Builder#setClusterHigh(int)}. The permitted
         * range is 0 (the default) to the value specified by
         * {@link Builder#setClusterHigh(int)}. Equality of Low and High is
         ...
         * the {@link Builder#setClusterLow(int)}. The permitted
         * range is the value specified by
         * {@link Builder#setClusterLow(int)} to 0xFFFF (the default). Equality of
