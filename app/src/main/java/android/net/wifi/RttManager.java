...
public class RttManager {
    ...
    /**
     * @deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_20_SUPPORT} API.
     */
    @Deprecated
    ...
    /**
     * @deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_40_SUPPORT} API.
     */
    @Deprecated
    ...
    /**
     * @deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_80_SUPPORT} API.
     */
    @Deprecated
    public static final int RTT_CHANNEL_WIDTH_80      = 2;

    /**@deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_160_SUPPORT} API.
     */
    @Deprecated
    ...
    /**@deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_5_SUPPORT} API.
     */
    @Deprecated
    public static final int RTT_CHANNEL_WIDTH_5       = 5;

    /**@deprecated It is not supported anymore.
     * Use {@link RttManager#RTT_BW_10_SUPPORT} API.
     */
    @Deprecated
    ...
    /** @deprecated Use the new {@link RttCapabilities} API */
    @Deprecated
    ...
    /** @deprecated Use the new {@link RttManager#getRttCapabilities()} API.*/
    @Deprecated
    ...
    public static class RttParams {
         ...
         * @deprecated Use the new {@link RttParams#numSamplesPerBurst}
         */
        @Deprecated
         ...
         * @deprecated
         * Use {@link RttParams#numRetriesPerMeasurementFrame} API.
         */
        @Deprecated
    ...
    public static class RttResult {
         ...
         * @deprecated Use {@link RttResult#measurementType}
         */
        @Deprecated
        public int requestType;
         ...
         * @deprecated Use {@link RttResult#rssiSpread} API.
         */
        @Deprecated
         ...
         * @deprecated Use {@link RttResult#txRate} API.
         */
        @Deprecated
        public int tx_rate;
        ...
        * @deprecated  Use {@link RttResult#rtt} API.
        */
        @Deprecated
        public long rtt_ns;
         ...
         * @deprecated Use {@link RttResult#rttStandardDeviation} API.
         */
        @Deprecated
         ...
         * @deprecated Use {@link RttResult#rttSpread} API.
         */
        @Deprecated
         ...
         * @deprecated use {@link RttResult#distance} API.
         */
        @Deprecated
         ...
         * @deprecated Use {@link RttResult#distanceSpread} API.
         */
        @Deprecated
    ...
    public static class RttClient implements Parcelable {
        ...
        public static final Creator<RttClient> CREATOR =
                new Creator<RttClient>() {
            @Override
            public RttClient createFromParcel(Parcel in) {
                return new RttClient(in);
            }

            @Override
            public RttClient[] newArray(int size) {
     ...
     * the standard {@link Context#WIFI_RTT_SERVICE Context.WIFI_RTT_SERVICE}.
