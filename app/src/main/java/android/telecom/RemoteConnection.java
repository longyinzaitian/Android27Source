...
public final class RemoteConnection {
    ...
    /**
     * {@link VideoProvider} associated with a {@link RemoteConnection}.  Used to
    ...
    public static class VideoProvider {
        ...
        /**
         * Callback class used by the {@link VideoProvider} to relay events from
        ...
        public abstract static class Callback {
             ...
             *
             * @param videoProvider The {@link VideoProvider} invoking this method.
         ...
         * currently capturing for the {@link VideoProvider}.
         *
        ...
        /**
         * Sets the device orientation, in degrees, for the {@link VideoProvider}.
        ...
        /**
         * Sets camera zoom ratio for the {@link VideoProvider}.
         *
         ...
         * properties for the {@link VideoProvider}.
         *
         ...
         * {@link RemoteConnection} for the {@link VideoProvider}.
         *
         ...
         * is paused, for the {@link VideoProvider}.
         *
    ...
    RemoteConnection(String callId, IConnectionService connectionService,
        ...
        if (videoProvider != null) {
            mVideoProvider = new VideoProvider(videoProvider, callingPackage,
                    targetSdkVersion);
        } else {
            mVideoProvider = null;
        }
