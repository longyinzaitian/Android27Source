...
public final class TelecomAnalytics implements Parcelable {
    public static final Creator<TelecomAnalytics> CREATOR =
            new Creator<TelecomAnalytics> () {
    ...
    public static final class SessionTiming extends TimedEvent<Integer> implements Parcelable {
        public static final Creator<SessionTiming> CREATOR =
                new Creator<SessionTiming> () {
