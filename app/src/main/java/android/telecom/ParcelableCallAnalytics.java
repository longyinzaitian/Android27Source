...
public class ParcelableCallAnalytics implements Parcelable {
    ...
    public static final class VideoEvent implements Parcelable {
        ...
        public static final Creator<VideoEvent> CREATOR =
                new Creator<VideoEvent> () {
    ...
    public static final class AnalyticsEvent implements Parcelable {
        ...
        public static final Creator<AnalyticsEvent> CREATOR =
                new Creator<AnalyticsEvent> () {
    ...
    public static final class EventTiming implements Parcelable {
        ...
        public static final Creator<EventTiming> CREATOR =
                new Creator<EventTiming> () {
    ...
    public static final Creator<ParcelableCallAnalytics> CREATOR =
            new Creator<ParcelableCallAnalytics> () {
