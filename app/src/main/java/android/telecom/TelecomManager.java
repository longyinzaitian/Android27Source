...
public class TelecomManager {
     ...
     * (see {@link ConnectionService}). Telecom reads the Intent extras to find
     * and bind to the appropriate {@link ConnectionService} which Telecom will
     ...
     * {@link ConnectionService} that Telecom should bind to. Telecom will then
    ...
    /**
     * An {@link Intent} action sent by the telecom framework to start a
     ...
     * <p>
     * A user can access the list of enabled {@link PhoneAccount}s through the Phone
    ...
    /**
     * The {@link Intent} action used to show the call accessibility settings page.
     */
    ...
    /**
     * {@link Intent} action used indicate that a new phone account was just
     * registered.
     * <p>
    ...
    /**
     * {@link Intent} action used indicate that a phone account was just
     * unregistered.
     * <p>
     * The Intent {@link Intent#getExtras() extras} will contain {@link #EXTRA_PHONE_ACCOUNT_HANDLE}
    ...
    /**
     * Optional extra for {@link Intent#ACTION_CALL} containing a boolean that
    ...
    /**
     * Optional extra for {@link Intent#ACTION_CALL} containing an integer that
    ...
    /**
     * The extra used with an {@link Intent#ACTION_CALL} and
     * {@link Intent#ACTION_DIAL} {@code Intent} to specify a
     * {@link PhoneAccountHandle} to use when making the call.
     * <p class="note">
     * Retrieve with {@link Intent#getParcelableExtra(String)}.
     */
    public static final String EXTRA_PHONE_ACCOUNT_HANDLE =
            "android.telecom.extra.PHONE_ACCOUNT_HANDLE";

    /**
     * Optional extra for {@link Intent#ACTION_CALL} containing a string call
    ...
    /**
     * Optional extra for {@link Intent#ACTION_CALL} and
     * {@link Intent#ACTION_DIAL} {@code Intent} containing a {@link Bundle}
    ...
    /**
     * Optional extra for {@link TelephonyManager#ACTION_PHONE_STATE_CHANGED}
    ...
    /**
     * An optional {@link Intent#ACTION_CALL} intent extra denoting the
     * package name of the app specifying an alternative gateway for the call.
     * The value is a string.
     *
     * (The following comment corresponds to the all GATEWAY_* extras)
     * An app which sends the {@link Intent#ACTION_CALL} intent can specify an
    ...
    /**
     * An optional {@link Intent#ACTION_CALL} intent extra corresponding to the
     ...
     * this if the {@link TelephonyManager#getLine1Number()} value, as that is the
     ...
     * an RTT session open. See {@link Call.RttCall} for more information on RTT.
     */
    ...
    */
     ...
     *
     * Requires permission: {@link Manifest.permission#READ_PHONE_STATE}
     *
     ...
     * <p>
     * Requires permission {@link Manifest.permission#READ_PHONE_STATE}, or that the caller
     * is the default dialer app.
     * <p>
     * A {@link SecurityException} will be thrown if a called is not the default dialer, or lacks
     * the {@link Manifest.permission#READ_PHONE_STATE} permission.
     *
     * @return A list of {@code PhoneAccountHandle} objects.
     */
    @RequiresPermission(Manifest.permission.READ_PHONE_STATE)
     ...
     *         the default dialer.
     *
     * Requires permission: {@link Manifest.permission#MODIFY_PHONE_STATE}
     * Requires permission: {@link Manifest.permission#WRITE_SECURE_SETTINGS}
     *
     * @hide
     */
     ...
     * {@link Manifest.permission#READ_PHONE_STATE} permission. This is intentional, to
     ...
     *
     * Requires permission: {@link Manifest.permission#MODIFY_PHONE_STATE} or
     * {@link Manifest.permission#ANSWER_PHONE_CALLS}
     */
     ...
     * {@link Manifest.permission#MANAGE_OWN_CALLS} to add a new incoming call.
     * <p>
     ...
     * does not have {@link Manifest.permission#MANAGE_OWN_CALLS}.
     *
     ...
     * {@link Manifest.permission#READ_PHONE_STATE} permission.
     * </p>
     *
     ...
     * associated {@link PhoneAccountHandle}.
     *
     * Self-managed {@link ConnectionService}s require permission
     * {@link Manifest.permission#MANAGE_OWN_CALLS}.
     *
     * @param address The address to make the call to.
     * @param extras Bundle of extras to use with the call.
     */
    @RequiresPermission(anyOf = {Manifest.permission.CALL_PHONE,
