...
public abstract class InCallService extends Service {
     ...
     * {@link Call.Callback#onConnectionEvent(Call, String, Bundle)} callback.
     * <p>
    ...
    public static abstract class VideoCall {
         ...
         * received via {@link Callback#onSessionModifyRequestReceived}.
         * <p>
         * Handled by
         ...
         * {@link Callback#onCameraCapabilitiesChanged(VideoProfile.CameraCapabilities)}.
         * <p>
         ...
         * to the caller via {@link Callback#onCallDataUsageChanged}.
         * <p>
         ...
         * instance its {@link Callback} implementation and set it on the
